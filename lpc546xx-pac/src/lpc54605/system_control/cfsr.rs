...
pub type IACCVIOL_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, IACCVIOL_A, 0>;
impl<'a> IACCVIOL_W<'a> {
...
pub type DACCVIOL_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, DACCVIOL_A, 1>;
impl<'a> DACCVIOL_W<'a> {
...
pub type MUNSTKERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, MUNSTKERR_A, 3>;
...
pub type MSTKERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, MSTKERR_A, 4>;
impl<'a> MSTKERR_W<'a> {
...
pub type MLSPERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, MLSPERR_A, 5>;
impl<'a> MLSPERR_W<'a> {
...
pub type MMARVALID_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, MMARVALID_A, 7>;
...
pub type IBUSERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, IBUSERR_A, 8>;
impl<'a> IBUSERR_W<'a> {
...
pub type PRECISERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, PRECISERR_A, 9>;
...
pub type IMPRECISERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, IMPRECISERR_A, 10>;
...
pub type UNSTKERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, UNSTKERR_A, 11>;
impl<'a> UNSTKERR_W<'a> {
    #[doc = "no unstacking fault"]
    #[inline(always)]
...
pub type STKERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, STKERR_A, 12>;
impl<'a> STKERR_W<'a> {
    #[doc = "no stacking fault"]
    #[inline(always)]
...
pub type LSPERR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, LSPERR_A, 13>;
impl<'a> LSPERR_W<'a> {
...
pub type BFARVALID_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, BFARVALID_A, 15>;
...
pub type UNDEFINSTR_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, UNDEFINSTR_A, 16>;
...
pub type INVSTATE_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, INVSTATE_A, 17>;
impl<'a> INVSTATE_W<'a> {
...
pub type INVPC_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, INVPC_A, 18>;
impl<'a> INVPC_W<'a> {
...
pub type NOCP_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, NOCP_A, 19>;
impl<'a> NOCP_W<'a> {
...
pub type UNALIGNED_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, UNALIGNED_A, 24>;
...
pub type DIVBYZERO_W<'a> = crate::BitWriter<'a, u32, CFSR_SPEC, DIVBYZERO_A, 25>;
