...
pub type ENABLE_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, ENABLE_A, 0>;
impl<'a> ENABLE_W<'a> {
...
pub type DATALEN_W<'a> = crate::FieldWriter<'a, u32, CFG_SPEC, u8, DATALEN_A, 2, 2>;
impl<'a> DATALEN_W<'a> {
...
pub type PARITYSEL_W<'a> = crate::FieldWriter<'a, u32, CFG_SPEC, u8, PARITYSEL_A, 2, 4>;
...
pub type STOPLEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, STOPLEN_A, 6>;
impl<'a> STOPLEN_W<'a> {
    #[doc = "1 stop bit."]
    #[inline(always)]
...
pub type MODE32K_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, MODE32K_A, 7>;
impl<'a> MODE32K_W<'a> {
...
pub type LINMODE_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, LINMODE_A, 8>;
impl<'a> LINMODE_W<'a> {
...
pub type CTSEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, CTSEN_A, 9>;
impl<'a> CTSEN_W<'a> {
...
pub type SYNCEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, SYNCEN_A, 11>;
impl<'a> SYNCEN_W<'a> {
...
pub type CLKPOL_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, CLKPOL_A, 12>;
impl<'a> CLKPOL_W<'a> {
...
pub type SYNCMST_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, SYNCMST_A, 14>;
impl<'a> SYNCMST_W<'a> {
...
pub type LOOP_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, LOOP_A, 15>;
impl<'a> LOOP_W<'a> {
...
pub type OETA_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, OETA_A, 18>;
impl<'a> OETA_W<'a> {
...
pub type AUTOADDR_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, AUTOADDR_A, 19>;
impl<'a> AUTOADDR_W<'a> {
...
pub type OESEL_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, OESEL_A, 20>;
impl<'a> OESEL_W<'a> {
...
pub type OEPOL_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, OEPOL_A, 21>;
impl<'a> OEPOL_W<'a> {
...
pub type RXPOL_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, RXPOL_A, 22>;
impl<'a> RXPOL_W<'a> {
...
pub type TXPOL_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, TXPOL_A, 23>;
impl<'a> TXPOL_W<'a> {
