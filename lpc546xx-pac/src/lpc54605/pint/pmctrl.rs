...
pub type SEL_PMATCH_W<'a> = crate::BitWriter<'a, u32, PMCTRL_SPEC, SEL_PMATCH_A, 0>;
...
pub type ENA_RXEV_W<'a> = crate::BitWriter<'a, u32, PMCTRL_SPEC, ENA_RXEV_A, 1>;
impl<'a> ENA_RXEV_W<'a> {
...
pub type PMAT_W<'a> = crate::FieldWriter<'a, u32, PMCTRL_SPEC, u8, u8, 8, 24>;
impl R {
