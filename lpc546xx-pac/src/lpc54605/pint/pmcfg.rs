...
pub type PROD_ENDPTS0_W<'a> = crate::BitWriter<'a, u32, PMCFG_SPEC, PROD_ENDPTS0_A, 0>;
...
pub type PROD_ENDPTS1_W<'a> = crate::BitWriter<'a, u32, PMCFG_SPEC, PROD_ENDPTS1_A, 1>;
...
pub type PROD_ENDPTS2_W<'a> = crate::BitWriter<'a, u32, PMCFG_SPEC, PROD_ENDPTS2_A, 2>;
...
pub type PROD_ENDPTS3_W<'a> = crate::BitWriter<'a, u32, PMCFG_SPEC, PROD_ENDPTS3_A, 3>;
...
pub type PROD_ENDPTS4_W<'a> = crate::BitWriter<'a, u32, PMCFG_SPEC, PROD_ENDPTS4_A, 4>;
...
pub type PROD_ENDPTS5_W<'a> = crate::BitWriter<'a, u32, PMCFG_SPEC, PROD_ENDPTS5_A, 5>;
...
pub type PROD_ENDPTS6_W<'a> = crate::BitWriter<'a, u32, PMCFG_SPEC, PROD_ENDPTS6_A, 6>;
...
pub type CFG0_W<'a> = crate::FieldWriterSafe<'a, u32, PMCFG_SPEC, u8, CFG0_A, 3, 8>;
impl<'a> CFG0_W<'a> {
...
pub type CFG1_W<'a> = crate::FieldWriterSafe<'a, u32, PMCFG_SPEC, u8, CFG1_A, 3, 11>;
impl<'a> CFG1_W<'a> {
    #[doc = "Constant HIGH. This bit slice always contributes to a product term match."]
    #[inline(always)]
    pub fn constant_high(self) -> &'a mut W {
...
pub type CFG2_W<'a> = crate::FieldWriterSafe<'a, u32, PMCFG_SPEC, u8, CFG2_A, 3, 14>;
impl<'a> CFG2_W<'a> {
    #[doc = "Constant HIGH. This bit slice always contributes to a product term match."]
    #[inline(always)]
    pub fn constant_high(self) -> &'a mut W {
...
pub type CFG3_W<'a> = crate::FieldWriterSafe<'a, u32, PMCFG_SPEC, u8, CFG3_A, 3, 17>;
impl<'a> CFG3_W<'a> {
    #[doc = "Constant HIGH. This bit slice always contributes to a product term match."]
    #[inline(always)]
    pub fn constant_high(self) -> &'a mut W {
...
pub type CFG4_W<'a> = crate::FieldWriterSafe<'a, u32, PMCFG_SPEC, u8, CFG4_A, 3, 20>;
impl<'a> CFG4_W<'a> {
    #[doc = "Constant HIGH. This bit slice always contributes to a product term match."]
    #[inline(always)]
    pub fn constant_high(self) -> &'a mut W {
...
pub type CFG5_W<'a> = crate::FieldWriterSafe<'a, u32, PMCFG_SPEC, u8, CFG5_A, 3, 23>;
impl<'a> CFG5_W<'a> {
    #[doc = "Constant HIGH. This bit slice always contributes to a product term match."]
    #[inline(always)]
    pub fn constant_high(self) -> &'a mut W {
...
pub type CFG6_W<'a> = crate::FieldWriterSafe<'a, u32, PMCFG_SPEC, u8, CFG6_A, 3, 26>;
impl<'a> CFG6_W<'a> {
    #[doc = "Constant HIGH. This bit slice always contributes to a product term match."]
    #[inline(always)]
    pub fn constant_high(self) -> &'a mut W {
...
pub type CFG7_W<'a> = crate::FieldWriterSafe<'a, u32, PMCFG_SPEC, u8, CFG7_A, 3, 29>;
impl<'a> CFG7_W<'a> {
    #[doc = "Constant HIGH. This bit slice always contributes to a product term match."]
    #[inline(always)]
    pub fn constant_high(self) -> &'a mut W {
