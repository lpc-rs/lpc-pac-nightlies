...
pub type MSTARBLOSS_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, MSTARBLOSS_A, 4>;
...
pub type MSTSTSTPERR_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, MSTSTSTPERR_A, 6>;
...
pub type SLVDESEL_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, SLVDESEL_A, 15>;
impl<'a> SLVDESEL_W<'a> {
...
pub type MONOV_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, MONOV_A, 17>;
impl<'a> MONOV_W<'a> {
...
pub type MONIDLE_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, MONIDLE_A, 19>;
impl<'a> MONIDLE_W<'a> {
...
pub type EVENTTIMEOUT_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, EVENTTIMEOUT_A, 24>;
...
pub type SCLTIMEOUT_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, SCLTIMEOUT_A, 25>;
