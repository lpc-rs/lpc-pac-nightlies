...
pub type SHADOWW_R = crate::FieldReader<u32, u32>;
#[doc = "Field `SHADOWW` writer - Timer counter match shadow value."]
pub type SHADOWW_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MSR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Timer counter match shadow value."]
    #[inline(always)]
    pub fn shadoww(&mut self) -> SHADOWW_W<0> {
        SHADOWW_W::new(self)
    }
