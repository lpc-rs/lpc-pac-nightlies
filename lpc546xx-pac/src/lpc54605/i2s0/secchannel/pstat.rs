...
pub type BUSY_W<'a> = crate::BitWriter<'a, u32, PSTAT_SPEC, bool, 0>;
...
pub type SLVFRMERR_W<'a> = crate::BitWriter<'a, u32, PSTAT_SPEC, bool, 1>;
#[doc = "Field `LR` reader - Left/Right indication."]
pub type LR_R = crate::BitReader<bool>;
#[doc = "Field `LR` writer - Left/Right indication."]
pub type LR_W<'a> = crate::BitWriter<'a, u32, PSTAT_SPEC, bool, 2>;
