...
pub type RS_W<'a> = crate::BitWriter<'a, u32, USBCMD_SPEC, bool, 0>;
...
pub type HCRESET_W<'a> = crate::BitWriter<'a, u32, USBCMD_SPEC, bool, 1>;
...
pub type FLS_W<'a> = crate::FieldWriter<'a, u32, USBCMD_SPEC, u8, u8, 2, 2>;
...
pub type HIRD_W<'a> = crate::FieldWriter<'a, u32, USBCMD_SPEC, u8, u8, 4, 24>;
...
pub type LPM_RWU_W<'a> = crate::BitWriter<'a, u32, USBCMD_SPEC, bool, 28>;
impl R {
