...
pub type RX_WMARK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FIFOTH_SPEC, u16, u16, 12, O>;
...
pub type DMA_MTS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FIFOTH_SPEC, u8, u8, 3, O>;
impl R {
...
impl W {
    ...
    #[doc = "Bits 28:30 - Burst size of multiple transaction; should be programmed same as DW-DMA controller multiple-transaction-size SRC/DEST_MSIZE."]
    #[inline(always)]
    pub fn dma_mts(&mut self) -> DMA_MTS_W<28> {
        DMA_MTS_W::new(self)
    }
