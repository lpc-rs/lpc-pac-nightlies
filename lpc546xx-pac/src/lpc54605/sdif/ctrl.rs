...
pub type INT_ENABLE_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 4>;
#[doc = "Field `READ_WAIT` reader - Read/wait."]
pub type READ_WAIT_R = crate::BitReader<bool>;
#[doc = "Field `READ_WAIT` writer - Read/wait."]
pub type READ_WAIT_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 6>;
...
pub type SEND_IRQ_RESPONSE_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 7>;
...
pub type ABORT_READ_DATA_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 8>;
#[doc = "Field `SEND_CCSD` reader - Send ccsd."]
pub type SEND_CCSD_R = crate::BitReader<bool>;
#[doc = "Field `SEND_CCSD` writer - Send ccsd."]
pub type SEND_CCSD_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 9>;
...
pub type SEND_AUTO_STOP_CCSD_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 10>;
...
pub type CEATA_DEVICE_INTERRUPT_STATUS_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 11>;
...
pub type CARD_VOLTAGE_A0_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 16>;
...
pub type CARD_VOLTAGE_A1_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 17>;
...
pub type CARD_VOLTAGE_A2_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 18>;
...
pub type USE_INTERNAL_DMAC_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 25>;
impl R {
