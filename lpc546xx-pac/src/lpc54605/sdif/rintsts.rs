...
pub type TXDR_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINTSTS_SPEC, bool, O>;
...
pub type RTO_BAR_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINTSTS_SPEC, bool, O>;
...
pub type DRTO_BDS_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINTSTS_SPEC, bool, O>;
...
pub type HTO_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINTSTS_SPEC, bool, O>;
...
pub type FRUN_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINTSTS_SPEC, bool, O>;
...
pub type EBE_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINTSTS_SPEC, bool, O>;
#[doc = "Field `SDIO_INTERRUPT` reader - Interrupt from SDIO card."]
pub type SDIO_INTERRUPT_R = crate::BitReader<bool>;
#[doc = "Field `SDIO_INTERRUPT` writer - Interrupt from SDIO card."]
pub type SDIO_INTERRUPT_W<'a, const O: u8> = crate::BitWriter<'a, u32, RINTSTS_SPEC, bool, O>;
impl R {
    ...
    pub fn sdio_interrupt(&self) -> SDIO_INTERRUPT_R {
        SDIO_INTERRUPT_R::new(((self.bits >> 16) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Card detect."]
    ...
    #[doc = "Bit 16 - Interrupt from SDIO card."]
    #[inline(always)]
    pub fn sdio_interrupt(&mut self) -> SDIO_INTERRUPT_W<16> {
        SDIO_INTERRUPT_W::new(self)
    }
