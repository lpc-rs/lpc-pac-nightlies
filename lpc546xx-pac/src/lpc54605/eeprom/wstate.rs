...
pub type PHASE3_W<'a> = crate::FieldWriter<'a, u32, WSTATE_SPEC, u8, u8, 8, 0>;
...
pub type PHASE2_W<'a> = crate::FieldWriter<'a, u32, WSTATE_SPEC, u8, u8, 8, 8>;
...
pub type PHASE1_W<'a> = crate::FieldWriter<'a, u32, WSTATE_SPEC, u8, u8, 8, 16>;
...
pub type LCK_PARWEP_W<'a> = crate::BitWriter<'a, u32, WSTATE_SPEC, bool, 31>;
impl R {
