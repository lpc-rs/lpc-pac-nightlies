...
pub type NOC_W<'a> = crate::FieldWriter<'a, u32, MODCFG_SPEC, u8, u8, 4, 0>;
...
pub type NOB_W<'a> = crate::FieldWriter<'a, u32, MODCFG_SPEC, u8, u8, 5, 4>;
...
pub type MULTITASK_W<'a> = crate::BitWriter<'a, u32, MODCFG_SPEC, MULTITASK_A, 31>;
