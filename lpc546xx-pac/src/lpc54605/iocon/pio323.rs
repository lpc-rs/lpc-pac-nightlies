...
pub type FUNC_W<'a> = crate::FieldWriter<'a, u32, PIO323_SPEC, u8, FUNC_A, 4, 0>;
impl<'a> FUNC_W<'a> {
...
pub type I2CSLEW_W<'a> = crate::BitWriter<'a, u32, PIO323_SPEC, I2CSLEW_A, 6>;
impl<'a> I2CSLEW_W<'a> {
    #[doc = "I2C mode."]
    #[inline(always)]
...
pub type INVERT_W<'a> = crate::BitWriter<'a, u32, PIO323_SPEC, INVERT_A, 7>;
impl<'a> INVERT_W<'a> {
...
pub type DIGIMODE_W<'a> = crate::BitWriter<'a, u32, PIO323_SPEC, DIGIMODE_A, 8>;
impl<'a> DIGIMODE_W<'a> {
    #[doc = "Analog mode."]
    #[inline(always)]
...
pub type FILTEROFF_W<'a> = crate::BitWriter<'a, u32, PIO323_SPEC, FILTEROFF_A, 9>;
...
pub type I2CDRIVE_W<'a> = crate::BitWriter<'a, u32, PIO323_SPEC, I2CDRIVE_A, 10>;
impl<'a> I2CDRIVE_W<'a> {
...
pub type I2CFILTER_W<'a> = crate::BitWriter<'a, u32, PIO323_SPEC, I2CFILTER_A, 11>;
