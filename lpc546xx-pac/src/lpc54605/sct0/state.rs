...
pub type STATE_L_R = crate::FieldReader<u8, u8>;
#[doc = "Field `STATE_L` writer - State variable."]
pub type STATE_L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, STATE_SPEC, u8, u8, 5, O>;
#[doc = "Field `STATE_H` reader - State variable."]
pub type STATE_H_R = crate::FieldReader<u8, u8>;
#[doc = "Field `STATE_H` writer - State variable."]
pub type STATE_H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, STATE_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - State variable."]
    #[inline(always)]
    pub fn state_l(&mut self) -> STATE_L_W<0> {
        STATE_L_W::new(self)
    }
    #[doc = "Bits 16:20 - State variable."]
    #[inline(always)]
    pub fn state_h(&mut self) -> STATE_H_W<16> {
        STATE_H_W::new(self)
    }
