...
pub type INTITIALCOUNT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `IntitialCount` writer - Initial count."]
pub type INTITIALCOUNT_W<'a> = crate::FieldWriter<'a, u32, CNTRLDVR1_SPEC, u16, u16, 16, 0>;
impl R {
