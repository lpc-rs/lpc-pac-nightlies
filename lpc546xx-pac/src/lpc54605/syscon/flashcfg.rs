...
pub type FETCHCFG_W<'a> = crate::FieldWriter<'a, u32, FLASHCFG_SPEC, u8, FETCHCFG_A, 2, 0>;
impl<'a> FETCHCFG_W<'a> {
...
pub type DATACFG_W<'a> = crate::FieldWriter<'a, u32, FLASHCFG_SPEC, u8, DATACFG_A, 2, 2>;
impl<'a> DATACFG_W<'a> {
...
pub type ACCEL_W<'a> = crate::BitWriter<'a, u32, FLASHCFG_SPEC, ACCEL_A, 4>;
impl<'a> ACCEL_W<'a> {
...
pub type PREFEN_W<'a> = crate::BitWriter<'a, u32, FLASHCFG_SPEC, PREFEN_A, 5>;
impl<'a> PREFEN_W<'a> {
...
pub type PREFOVR_W<'a> = crate::BitWriter<'a, u32, FLASHCFG_SPEC, PREFOVR_A, 6>;
impl<'a> PREFOVR_W<'a> {
...
pub type FLASHTIM_W<'a> = crate::FieldWriter<'a, u32, FLASHCFG_SPEC, u8, FLASHTIM_A, 4, 12>;
impl<'a> FLASHTIM_W<'a> {
