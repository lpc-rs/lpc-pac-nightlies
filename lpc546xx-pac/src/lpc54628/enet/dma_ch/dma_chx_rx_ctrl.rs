...
pub type SR_W<'a> = crate::BitWriter<'a, u32, DMA_CHX_RX_CTRL_SPEC, bool, 0>;
...
pub type RBSZ_W<'a> = crate::FieldWriter<'a, u32, DMA_CHX_RX_CTRL_SPEC, u16, u16, 12, 3>;
...
pub type RXPBL_W<'a> = crate::FieldWriter<'a, u32, DMA_CHX_RX_CTRL_SPEC, u8, u8, 6, 16>;
...
pub type RPF_W<'a> = crate::BitWriter<'a, u32, DMA_CHX_RX_CTRL_SPEC, bool, 31>;
impl R {
