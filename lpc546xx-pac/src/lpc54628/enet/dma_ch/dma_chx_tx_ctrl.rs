...
pub type ST_W<'a> = crate::BitWriter<'a, u32, DMA_CHX_TX_CTRL_SPEC, bool, 0>;
...
pub type TCW_W<'a> = crate::FieldWriter<'a, u32, DMA_CHX_TX_CTRL_SPEC, u8, u8, 3, 1>;
...
pub type OSF_W<'a> = crate::BitWriter<'a, u32, DMA_CHX_TX_CTRL_SPEC, bool, 4>;
...
pub type TXPBL_W<'a> = crate::FieldWriter<'a, u32, DMA_CHX_TX_CTRL_SPEC, u8, u8, 6, 16>;
impl R {
