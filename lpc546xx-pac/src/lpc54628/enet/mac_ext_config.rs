...
pub type GPSL_W<'a> = crate::FieldWriter<'a, u32, MAC_EXT_CONFIG_SPEC, u16, u16, 14, 0>;
...
pub type DCRCC_W<'a> = crate::BitWriter<'a, u32, MAC_EXT_CONFIG_SPEC, bool, 16>;
...
pub type SPEN_W<'a> = crate::BitWriter<'a, u32, MAC_EXT_CONFIG_SPEC, bool, 17>;
...
pub type USP_W<'a> = crate::BitWriter<'a, u32, MAC_EXT_CONFIG_SPEC, bool, 18>;
impl R {
