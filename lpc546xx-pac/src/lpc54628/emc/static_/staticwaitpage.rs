...
pub type WAITPAGE_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WAITPAGE` writer - Asynchronous page mode read after the first read wait states."]
pub type WAITPAGE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, STATICWAITPAGE_SPEC, u8, u8, 5, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - Asynchronous page mode read after the first read wait states."]
    #[inline(always)]
    pub fn waitpage(&mut self) -> WAITPAGE_W<0> {
        WAITPAGE_W::new(self)
    }
