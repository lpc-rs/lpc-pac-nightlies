...
pub type PWMEN0_W<'a> = crate::BitWriter<'a, u32, PWMC_SPEC, PWMEN0_A, 0>;
impl<'a> PWMEN0_W<'a> {
...
pub type PWMEN1_W<'a> = crate::BitWriter<'a, u32, PWMC_SPEC, PWMEN1_A, 1>;
impl<'a> PWMEN1_W<'a> {
...
pub type PWMEN2_W<'a> = crate::BitWriter<'a, u32, PWMC_SPEC, PWMEN2_A, 2>;
impl<'a> PWMEN2_W<'a> {
...
pub type PWMEN3_W<'a> = crate::BitWriter<'a, u32, PWMC_SPEC, PWMEN3_A, 3>;
impl<'a> PWMEN3_W<'a> {
