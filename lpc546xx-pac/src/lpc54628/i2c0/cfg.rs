...
pub type MSTEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, MSTEN_A, 0>;
impl<'a> MSTEN_W<'a> {
...
pub type SLVEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, SLVEN_A, 1>;
impl<'a> SLVEN_W<'a> {
...
pub type MONEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, MONEN_A, 2>;
impl<'a> MONEN_W<'a> {
...
pub type TIMEOUTEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, TIMEOUTEN_A, 3>;
...
pub type MONCLKSTR_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, MONCLKSTR_A, 4>;
...
pub type HSCAPABLE_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, HSCAPABLE_A, 5>;
