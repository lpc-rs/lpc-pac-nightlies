...
pub type ATL_LAST_W<'a> = crate::FieldWriter<'a, u32, LAST_PTD_INUSE_SPEC, u8, u8, 5, 0>;
...
pub type ISO_LAST_W<'a> = crate::FieldWriter<'a, u32, LAST_PTD_INUSE_SPEC, u8, u8, 5, 8>;
...
pub type INT_LAST_W<'a> = crate::FieldWriter<'a, u32, LAST_PTD_INUSE_SPEC, u8, u8, 5, 16>;
impl R {
