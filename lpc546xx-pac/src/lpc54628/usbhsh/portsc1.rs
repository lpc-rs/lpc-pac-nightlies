...
pub type CCS_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 0>;
...
pub type PEDC_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 3>;
...
pub type OCA_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 4>;
...
pub type OCC_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 5>;
...
pub type FPR_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 6>;
...
pub type SUSP_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 7>;
...
pub type PR_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 8>;
...
pub type SUS_L1_R = crate::BitReader<bool>;
...
pub type SUS_L1_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 9>;
...
pub type PP_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 12>;
...
pub type PIC_W<'a> = crate::FieldWriter<'a, u32, PORTSC1_SPEC, u8, u8, 2, 14>;
...
pub type PTC_W<'a> = crate::FieldWriter<'a, u32, PORTSC1_SPEC, u8, u8, 4, 16>;
...
pub type PSPD_W<'a> = crate::FieldWriter<'a, u32, PORTSC1_SPEC, u8, u8, 2, 20>;
...
pub type WOO_W<'a> = crate::BitWriter<'a, u32, PORTSC1_SPEC, bool, 22>;
...
pub type SUS_STAT_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SUS_STAT` writer - These two bits are used by software to determine whether the most recent L1 suspend request was successful: 00b: Success-state transition was successful (ACK) 01b: Not Yet - Device was unable to enter the L1 state at this time (NYET) 10b: Not supported - Device does not support the L1 state (STALL) 11b: Timeout/Error - Device failed to respond or an error occurred."]
pub type SUS_STAT_W<'a> = crate::FieldWriter<'a, u32, PORTSC1_SPEC, u8, u8, 2, 23>;
...
pub type DEV_ADD_W<'a> = crate::FieldWriter<'a, u32, PORTSC1_SPEC, u8, u8, 7, 25>;
impl R {
