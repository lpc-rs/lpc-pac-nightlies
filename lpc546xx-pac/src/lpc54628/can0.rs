...
pub mod tocc;
#[doc = "TOCV (r) register accessor: an alias for `Reg<TOCV_SPEC>`"]
...
pub mod txbc;
#[doc = "TXFQS (rw) register accessor: an alias for `Reg<TXFQS_SPEC>`"]
...
pub mod txesc;
#[doc = "TXBRP (rw) register accessor: an alias for `Reg<TXBRP_SPEC>`"]
...
pub mod txbto;
#[doc = "TXBCF (rw) register accessor: an alias for `Reg<TXBCF_SPEC>`"]
...
pub mod txefa;
#[doc = "MRBA (rw) register accessor: an alias for `Reg<MRBA_SPEC>`"]
pub type MRBA = crate::Reg<mrba::MRBA_SPEC>;
#[doc = "CAN Message RAM Base Address"]
pub mod mrba;
#[doc = "ETSCC (rw) register accessor: an alias for `Reg<ETSCC_SPEC>`"]
pub type ETSCC = crate::Reg<etscc::ETSCC_SPEC>;
#[doc = "External Timestamp Counter Configuration"]
pub mod etscc;
#[doc = "ETSCV (rw) register accessor: an alias for `Reg<ETSCV_SPEC>`"]
