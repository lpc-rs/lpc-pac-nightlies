...
pub type MODE_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 2, 0>;
...
pub type NEW_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 4>;
...
pub type DMA_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 8>;
impl R {
