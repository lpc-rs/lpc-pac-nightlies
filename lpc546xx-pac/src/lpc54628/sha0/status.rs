...
pub type WAITING_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 0>;
...
pub type DIGEST_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 1>;
...
pub type ERROR_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 2>;
impl R {
