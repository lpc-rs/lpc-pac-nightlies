...
pub type FIFO_RX_WATERMARK_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 0>;
...
pub type FIFO_TX_WATERMARK_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 1>;
...
pub type FIFO_EMPTY_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 2>;
...
pub type FIFO_FULL_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 3>;
...
pub type CMDFSMSTATES_W<'a> = crate::FieldWriter<'a, u32, STATUS_SPEC, u8, u8, 4, 4>;
...
pub type DATA_3_STATUS_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 8>;
...
0 - card data not busy 1 - card data busy."]
pub type DATA_BUSY_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 9>;
...
pub type DATA_STATE_MC_BUSY_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 10>;
...
pub type RESPONSE_INDEX_W<'a> = crate::FieldWriter<'a, u32, STATUS_SPEC, u8, u8, 6, 11>;
...
pub type FIFO_COUNT_W<'a> = crate::FieldWriter<'a, u32, STATUS_SPEC, u16, u16, 13, 17>;
...
pub type DMA_ACK_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 30>;
...
pub type DMA_REQ_W<'a> = crate::BitWriter<'a, u32, STATUS_SPEC, bool, 31>;
impl R {
