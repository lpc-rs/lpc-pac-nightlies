...
pub type DATALEN_W<'a> = crate::FieldWriter<'a, u32, CMD_SPEC, u16, u16, 14, 0>;
...
pub type POLL_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 14>;
...
pub type DOUT_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, DOUT_A, 15>;
impl<'a> DOUT_W<'a> {
...
pub type INTLEN_W<'a> = crate::FieldWriter<'a, u32, CMD_SPEC, u8, u8, 3, 16>;
...
pub type FIELDFORM_W<'a> = crate::FieldWriterSafe<'a, u32, CMD_SPEC, u8, FIELDFORM_A, 2, 19>;
...
pub type FRAMEFORM_W<'a> = crate::FieldWriter<'a, u32, CMD_SPEC, u8, FRAMEFORM_A, 3, 21>;
...
pub type OPCODE_W<'a> = crate::FieldWriter<'a, u32, CMD_SPEC, u8, u8, 8, 24>;
impl R {
