...
pub type MAXIMUMPORTSIZE_R = crate::FieldReader<u8, u8>;
...
pub type MAXIMUMPORTSIZE3_R = crate::BitReader<bool>;
...
pub type PORTSIZESUPPORTED_R = crate::BitReader<bool>;
...
pub type PORTMODESUPPORTED_R = crate::BitReader<bool>;
...
pub type NOFETCHCOMPARISONS_R = crate::BitReader<bool>;
impl R {
    ...
    pub fn maximum_port_size(&self) -> MAXIMUMPORTSIZE_R {
        MAXIMUMPORTSIZE_R::new((self.bits & 7) as u8)
    }
...
of the ETMCCR."]
    ...
    pub fn maximum_port_size3(&self) -> MAXIMUMPORTSIZE3_R {
        MAXIMUMPORTSIZE3_R::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    pub fn port_size_supported(&self) -> PORTSIZESUPPORTED_R {
        PORTSIZESUPPORTED_R::new(((self.bits >> 10) & 1) != 0)
    }
    ...
    pub fn port_mode_supported(&self) -> PORTMODESUPPORTED_R {
        PORTMODESUPPORTED_R::new(((self.bits >> 11) & 1) != 0)
    }
    ...
    pub fn no_fetch_comparisons(&self) -> NOFETCHCOMPARISONS_R {
        NOFETCHCOMPARISONS_R::new(((self.bits >> 17) & 1) != 0)
    }
}
