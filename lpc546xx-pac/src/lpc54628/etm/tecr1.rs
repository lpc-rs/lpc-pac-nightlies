...
pub type TRACE_CONTROL_ENABLE_R = crate::BitReader<TRACE_CONTROL_ENABLE_A>;
#[doc = "Trace start/stop enable. The trace start/stop resource, resource 0x5F, is unaffected by the value of this bit.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum TRACE_CONTROL_ENABLE_A {
    #[doc = "0: Tracing is unaffected by the trace start/stop logic."]
    TRACE_CONTROL_ENABLE_0 = 0,
    #[doc = "1: Tracing is controlled by the trace on and off addresses configured for the trace start/stop logic."]
    TRACE_CONTROL_ENABLE_1 = 1,
}
impl From<TRACE_CONTROL_ENABLE_A> for bool {
    #[inline(always)]
    fn from(variant: TRACE_CONTROL_ENABLE_A) -> Self {
        variant as u8 != 0
    }
}
impl TRACE_CONTROL_ENABLE_R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub fn variant(&self) -> TRACE_CONTROL_ENABLE_A {
        match self.bits {
            false => TRACE_CONTROL_ENABLE_A::TRACE_CONTROL_ENABLE_0,
            true => TRACE_CONTROL_ENABLE_A::TRACE_CONTROL_ENABLE_1,
        }
    }
    #[doc = "Checks if the value of the field is `TRACE_CONTROL_ENABLE_0`"]
    #[inline(always)]
    pub fn is_trace_control_enable_0(&self) -> bool {
        *self == TRACE_CONTROL_ENABLE_A::TRACE_CONTROL_ENABLE_0
    }
    #[doc = "Checks if the value of the field is `TRACE_CONTROL_ENABLE_1`"]
    #[inline(always)]
    pub fn is_trace_control_enable_1(&self) -> bool {
        *self == TRACE_CONTROL_ENABLE_A::TRACE_CONTROL_ENABLE_1
    }
}
...
pub type TRACE_CONTROL_ENABLE_W<'a, const O: u8> =
    crate::BitWriter<'a, u32, TECR1_SPEC, TRACE_CONTROL_ENABLE_A, O>;
impl<'a, const O: u8> TRACE_CONTROL_ENABLE_W<'a, O> {
    #[doc = "Tracing is unaffected by the trace start/stop logic."]
    #[inline(always)]
    pub fn trace_control_enable_0(self) -> &'a mut W {
        self.variant(TRACE_CONTROL_ENABLE_A::TRACE_CONTROL_ENABLE_0)
    }
    ...
    pub fn trace_control_enable_1(self) -> &'a mut W {
        self.variant(TRACE_CONTROL_ENABLE_A::TRACE_CONTROL_ENABLE_1)
    }
}
impl R {
    #[doc = "Bit 25 - Trace start/stop enable. The trace start/stop resource, resource 0x5F, is unaffected by the value of this bit."]
    #[inline(always)]
    pub fn trace_control_enable(&self) -> TRACE_CONTROL_ENABLE_R {
        TRACE_CONTROL_ENABLE_R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 25 - Trace start/stop enable. The trace start/stop resource, resource 0x5F, is unaffected by the value of this bit."]
    #[inline(always)]
    pub fn trace_control_enable(&mut self) -> TRACE_CONTROL_ENABLE_W<25> {
        TRACE_CONTROL_ENABLE_W::new(self)
    }
