...
pub type NDEC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AUDPLLNDEC_SPEC, u16, u16, 10, O>;
#[doc = "Field `NREQ` reader - NDEC reload request."]
pub type NREQ_R = crate::BitReader<bool>;
#[doc = "Field `NREQ` writer - NDEC reload request."]
pub type NREQ_W<'a, const O: u8> = crate::BitWriter<'a, u32, AUDPLLNDEC_SPEC, bool, O>;
impl R {
