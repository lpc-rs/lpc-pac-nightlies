...
pub type CCLK_DRV_PHASE_W<'a> = crate::FieldWriter<'a, u32, SDIOCLKCTRL_SPEC, u8, u8, 2, 0>;
...
pub type CCLK_SAMPLE_PHASE_W<'a> = crate::FieldWriter<'a, u32, SDIOCLKCTRL_SPEC, u8, u8, 2, 2>;
...
pub type PHASE_ACTIVE_W<'a> = crate::BitWriter<'a, u32, SDIOCLKCTRL_SPEC, bool, 7>;
...
pub type CCLK_DRV_DELAY_W<'a> = crate::FieldWriter<'a, u32, SDIOCLKCTRL_SPEC, u8, u8, 5, 16>;
...
pub type CCLK_DRV_DELAY_ACTIVE_W<'a> = crate::BitWriter<'a, u32, SDIOCLKCTRL_SPEC, bool, 23>;
...
pub type CCLK_SAMPLE_DELAY_W<'a> = crate::FieldWriter<'a, u32, SDIOCLKCTRL_SPEC, u8, u8, 5, 24>;
...
pub type CCLK_SAMPLE_DELAY_ACTIVE_W<'a> = crate::BitWriter<'a, u32, SDIOCLKCTRL_SPEC, bool, 31>;
impl R {
