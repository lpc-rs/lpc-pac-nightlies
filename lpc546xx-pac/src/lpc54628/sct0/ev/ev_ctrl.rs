...
pub type MATCHSEL_W<'a> = crate::FieldWriter<'a, u32, EV_CTRL_SPEC, u8, u8, 4, 0>;
...
pub type HEVENT_W<'a> = crate::BitWriter<'a, u32, EV_CTRL_SPEC, HEVENT_A, 4>;
impl<'a> HEVENT_W<'a> {
...
pub type OUTSEL_W<'a> = crate::BitWriter<'a, u32, EV_CTRL_SPEC, OUTSEL_A, 5>;
impl<'a> OUTSEL_W<'a> {
...
pub type IOSEL_W<'a> = crate::FieldWriter<'a, u32, EV_CTRL_SPEC, u8, u8, 4, 6>;
...
pub type IOCOND_W<'a> = crate::FieldWriterSafe<'a, u32, EV_CTRL_SPEC, u8, IOCOND_A, 2, 10>;
impl<'a> IOCOND_W<'a> {
    #[doc = "LOW"]
    #[inline(always)]
...
pub type COMBMODE_W<'a> = crate::FieldWriterSafe<'a, u32, EV_CTRL_SPEC, u8, COMBMODE_A, 2, 12>;
impl<'a> COMBMODE_W<'a> {
...
pub type STATELD_W<'a> = crate::BitWriter<'a, u32, EV_CTRL_SPEC, STATELD_A, 14>;
impl<'a> STATELD_W<'a> {
...
pub type STATEV_W<'a> = crate::FieldWriter<'a, u32, EV_CTRL_SPEC, u8, u8, 5, 15>;
...
pub type MATCHMEM_W<'a> = crate::BitWriter<'a, u32, EV_CTRL_SPEC, bool, 20>;
...
pub type DIRECTION_W<'a> = crate::FieldWriter<'a, u32, EV_CTRL_SPEC, u8, DIRECTION_A, 2, 21>;
