...
pub type TXERR_W<'a> = crate::BitWriter<'a, u32, FIFOINTENSET_SPEC, TXERR_A, 0>;
impl<'a> TXERR_W<'a> {
...
pub type RXERR_W<'a> = crate::BitWriter<'a, u32, FIFOINTENSET_SPEC, RXERR_A, 1>;
impl<'a> RXERR_W<'a> {
...
pub type TXLVL_W<'a> = crate::BitWriter<'a, u32, FIFOINTENSET_SPEC, TXLVL_A, 2>;
impl<'a> TXLVL_W<'a> {
...
pub type RXLVL_W<'a> = crate::BitWriter<'a, u32, FIFOINTENSET_SPEC, RXLVL_A, 3>;
impl<'a> RXLVL_W<'a> {
