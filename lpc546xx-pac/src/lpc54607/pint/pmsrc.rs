...
pub type SRC0_W<'a> = crate::FieldWriterSafe<'a, u32, PMSRC_SPEC, u8, SRC0_A, 3, 8>;
impl<'a> SRC0_W<'a> {
...
pub type SRC1_W<'a> = crate::FieldWriterSafe<'a, u32, PMSRC_SPEC, u8, SRC1_A, 3, 11>;
impl<'a> SRC1_W<'a> {
...
pub type SRC2_W<'a> = crate::FieldWriterSafe<'a, u32, PMSRC_SPEC, u8, SRC2_A, 3, 14>;
impl<'a> SRC2_W<'a> {
...
pub type SRC3_W<'a> = crate::FieldWriterSafe<'a, u32, PMSRC_SPEC, u8, SRC3_A, 3, 17>;
impl<'a> SRC3_W<'a> {
...
pub type SRC4_W<'a> = crate::FieldWriterSafe<'a, u32, PMSRC_SPEC, u8, SRC4_A, 3, 20>;
impl<'a> SRC4_W<'a> {
...
pub type SRC5_W<'a> = crate::FieldWriterSafe<'a, u32, PMSRC_SPEC, u8, SRC5_A, 3, 23>;
impl<'a> SRC5_W<'a> {
...
pub type SRC6_W<'a> = crate::FieldWriterSafe<'a, u32, PMSRC_SPEC, u8, SRC6_A, 3, 26>;
impl<'a> SRC6_W<'a> {
...
pub type SRC7_W<'a> = crate::FieldWriterSafe<'a, u32, PMSRC_SPEC, u8, SRC7_A, 3, 29>;
impl<'a> SRC7_W<'a> {
