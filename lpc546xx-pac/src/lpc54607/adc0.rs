...
pub struct RegisterBlock {
    ...
    pub seq_ctrl: [crate::Reg<seq_ctrl::SEQ_CTRL_SPEC>; 2],
    ...
    pub seq_gdat: [crate::Reg<seq_gdat::SEQ_GDAT_SPEC>; 2],
    _reserved4: [u8; 0x08],
...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub fn seq_ctrla(&self) -> &crate::Reg<seq_ctrl::SEQ_CTRL_SPEC> {
        &self.seq_ctrl[0]
    }
    ...
    #[inline(always)]
    pub fn seq_ctrlb(&self) -> &crate::Reg<seq_ctrl::SEQ_CTRL_SPEC> {
        &self.seq_ctrl[1]
    }
    ...
    #[inline(always)]
    pub fn seq_gdata(&self) -> &crate::Reg<seq_gdat::SEQ_GDAT_SPEC> {
        &self.seq_gdat[0]
    }
    ...
    #[inline(always)]
    pub fn seq_gdatb(&self) -> &crate::Reg<seq_gdat::SEQ_GDAT_SPEC> {
        &self.seq_gdat[1]
    }
}
