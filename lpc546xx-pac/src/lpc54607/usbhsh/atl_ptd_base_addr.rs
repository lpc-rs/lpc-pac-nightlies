...
pub type ATL_CUR_W<'a> = crate::FieldWriter<'a, u32, ATL_PTD_BASE_ADDR_SPEC, u8, u8, 5, 4>;
...
pub type ATL_BASE_W<'a> = crate::FieldWriter<'a, u32, ATL_PTD_BASE_ADDR_SPEC, u32, u32, 23, 9>;
impl R {
