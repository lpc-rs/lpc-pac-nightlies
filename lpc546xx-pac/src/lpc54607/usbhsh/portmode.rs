...
pub type ID0_W<'a> = crate::BitWriter<'a, u32, PORTMODE_SPEC, bool, 0>;
...
pub type ID0_EN_W<'a> = crate::BitWriter<'a, u32, PORTMODE_SPEC, bool, 8>;
...
pub type DEV_ENABLE_W<'a> = crate::BitWriter<'a, u32, PORTMODE_SPEC, bool, 16>;
...
pub type SW_CTRL_PDCOM_W<'a> = crate::BitWriter<'a, u32, PORTMODE_SPEC, bool, 18>;
...
pub type SW_PDCOM_W<'a> = crate::BitWriter<'a, u32, PORTMODE_SPEC, bool, 19>;
impl R {
