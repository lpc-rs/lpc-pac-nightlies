...
pub type ENABLE_W<'a> = crate::BitWriter<'a, u32, CSR_SPEC, ENABLE_A, 0>;
impl<'a> ENABLE_W<'a> {
...
pub type TICKINT_W<'a> = crate::BitWriter<'a, u32, CSR_SPEC, TICKINT_A, 1>;
impl<'a> TICKINT_W<'a> {
...
pub type CLKSOURCE_W<'a> = crate::BitWriter<'a, u32, CSR_SPEC, CLKSOURCE_A, 2>;
