...
pub type CRC_POLY_W<'a> = crate::FieldWriter<'a, u32, MODE_SPEC, u8, u8, 2, 0>;
...
pub type BIT_RVS_DATA_W<'a> = crate::BitWriter<'a, u32, MODE_SPEC, bool, 2>;
...
pub type CMPL_DATA_W<'a> = crate::BitWriter<'a, u32, MODE_SPEC, bool, 3>;
...
pub type BIT_RVS_SUM_W<'a> = crate::BitWriter<'a, u32, MODE_SPEC, bool, 4>;
#[doc = "Field `CMPL_SUM` reader - Sum complement"]
pub type CMPL_SUM_R = crate::BitReader<bool>;
#[doc = "Field `CMPL_SUM` writer - Sum complement"]
pub type CMPL_SUM_W<'a> = crate::BitWriter<'a, u32, MODE_SPEC, bool, 5>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 2 - Data bit order"]
    #[inline(always)]
    pub fn bit_rvs_data(&mut self) -> BIT_RVS_DATA_W {
        BIT_RVS_DATA_W::new(self)
    }
    #[doc = "Bit 3 - Data complement"]
    #[inline(always)]
    pub fn cmpl_data(&mut self) -> CMPL_DATA_W {
