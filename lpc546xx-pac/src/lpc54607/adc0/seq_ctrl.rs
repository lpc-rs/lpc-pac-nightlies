...
pub type CHANNELS_W<'a> = crate::FieldWriter<'a, u32, SEQ_CTRL_SPEC, u16, u16, 12, 0>;
...
pub type TRIGGER_W<'a> = crate::FieldWriter<'a, u32, SEQ_CTRL_SPEC, u8, u8, 6, 12>;
...
pub type TRIGPOL_W<'a> = crate::BitWriter<'a, u32, SEQ_CTRL_SPEC, TRIGPOL_A, 18>;
impl<'a> TRIGPOL_W<'a> {
...
pub type SYNCBYPASS_W<'a> = crate::BitWriter<'a, u32, SEQ_CTRL_SPEC, SYNCBYPASS_A, 19>;
...
pub type START_W<'a> = crate::BitWriter<'a, u32, SEQ_CTRL_SPEC, bool, 26>;
...
pub type BURST_W<'a> = crate::BitWriter<'a, u32, SEQ_CTRL_SPEC, bool, 27>;
...
pub type SINGLESTEP_W<'a> = crate::BitWriter<'a, u32, SEQ_CTRL_SPEC, bool, 28>;
...
pub type LOWPRIO_W<'a> = crate::BitWriter<'a, u32, SEQ_CTRL_SPEC, LOWPRIO_A, 29>;
impl<'a> LOWPRIO_W<'a> {
...
pub type MODE_W<'a> = crate::BitWriter<'a, u32, SEQ_CTRL_SPEC, MODE_A, 30>;
impl<'a> MODE_W<'a> {
...
pub type SEQ_ENA_W<'a> = crate::BitWriter<'a, u32, SEQ_CTRL_SPEC, SEQ_ENA_A, 31>;
impl<'a> SEQ_ENA_W<'a> {
