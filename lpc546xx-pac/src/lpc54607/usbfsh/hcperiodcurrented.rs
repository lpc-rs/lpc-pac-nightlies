...
pub type PCED_R = crate::FieldReader<u32, u32>;
#[doc = "Field `PCED` writer - The content of this register is updated by HC after a periodic ED is processed."]
pub type PCED_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, HCPERIODCURRENTED_SPEC, u32, u32, 28, O>;
impl R {
