...
pub type VECTTBL_W<'a> = crate::BitWriter<'a, u32, HFSR_SPEC, VECTTBL_A, 1>;
impl<'a> VECTTBL_W<'a> {
...
pub type FORCED_W<'a> = crate::BitWriter<'a, u32, HFSR_SPEC, FORCED_A, 30>;
impl<'a> FORCED_W<'a> {
...
pub type DEBUGEVT_W<'a> = crate::BitWriter<'a, u32, HFSR_SPEC, bool, 31>;
impl R {
