...
pub type CTMODE_W<'a> = crate::FieldWriterSafe<'a, u32, CTCR_SPEC, u8, CTMODE_A, 2, 0>;
impl<'a> CTMODE_W<'a> {
...
pub type CINSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CTCR_SPEC, u8, CINSEL_A, 2, 2>;
impl<'a> CINSEL_W<'a> {
...
pub type ENCC_W<'a> = crate::BitWriter<'a, u32, CTCR_SPEC, bool, 4>;
...
pub type SELCC_W<'a> = crate::FieldWriter<'a, u32, CTCR_SPEC, u8, SELCC_A, 3, 5>;
impl<'a> SELCC_W<'a> {
