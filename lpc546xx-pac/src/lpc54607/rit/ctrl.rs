...
pub type RITINT_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 0>;
...
pub type RITENCLR_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 1>;
...
pub type RITENBR_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 2>;
#[doc = "Field `RITEN` reader - Timer enable."]
pub type RITEN_R = crate::BitReader<bool>;
#[doc = "Field `RITEN` writer - Timer enable."]
pub type RITEN_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 3>;
impl R {
