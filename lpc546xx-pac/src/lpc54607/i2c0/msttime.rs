...
pub type MSTSCLLOW_W<'a> = crate::FieldWriterSafe<'a, u32, MSTTIME_SPEC, u8, MSTSCLLOW_A, 3, 0>;
...
pub type MSTSCLHIGH_W<'a> = crate::FieldWriterSafe<'a, u32, MSTTIME_SPEC, u8, MSTSCLHIGH_A, 3, 4>;
