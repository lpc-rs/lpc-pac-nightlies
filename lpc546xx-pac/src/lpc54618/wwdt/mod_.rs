...
pub type WDEN_W<'a> = crate::BitWriter<'a, u32, MOD_SPEC, WDEN_A, 0>;
impl<'a> WDEN_W<'a> {
...
pub type WDRESET_W<'a> = crate::BitWriter<'a, u32, MOD_SPEC, WDRESET_A, 1>;
impl<'a> WDRESET_W<'a> {
...
pub type WDTOF_W<'a> = crate::BitWriter<'a, u32, MOD_SPEC, bool, 2>;
...
pub type WDINT_W<'a> = crate::BitWriter<'a, u32, MOD_SPEC, bool, 3>;
...
pub type WDPROTECT_W<'a> = crate::BitWriter<'a, u32, MOD_SPEC, WDPROTECT_A, 4>;
...
pub type LOCK_W<'a> = crate::BitWriter<'a, u32, MOD_SPEC, bool, 5>;
impl R {
