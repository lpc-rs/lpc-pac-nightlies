...
pub type FUFIC_W<'a> = crate::BitWriter<'a, u32, INTCLR_SPEC, bool, 1>;
#[doc = "Field `LNBUIC` writer - LCD next address base update interrupt clear."]
pub type LNBUIC_W<'a> = crate::BitWriter<'a, u32, INTCLR_SPEC, bool, 2>;
#[doc = "Field `VCOMPIC` writer - Vertical compare interrupt clear."]
pub type VCOMPIC_W<'a> = crate::BitWriter<'a, u32, INTCLR_SPEC, bool, 3>;
...
pub type BERIC_W<'a> = crate::BitWriter<'a, u32, INTCLR_SPEC, bool, 4>;
impl R {
