...
pub type UNIFY_W<'a> = crate::BitWriter<'a, u32, CONFIG_SPEC, UNIFY_A, 0>;
impl<'a> UNIFY_W<'a> {
...
pub type CLKMODE_W<'a> = crate::FieldWriterSafe<'a, u32, CONFIG_SPEC, u8, CLKMODE_A, 2, 1>;
impl<'a> CLKMODE_W<'a> {
...
pub type CKSEL_W<'a> = crate::FieldWriterSafe<'a, u32, CONFIG_SPEC, u8, CKSEL_A, 4, 3>;
impl<'a> CKSEL_W<'a> {
...
pub type NORELOAD_L_W<'a> = crate::BitWriter<'a, u32, CONFIG_SPEC, bool, 7>;
...
pub type NORELOAD_H_W<'a> = crate::BitWriter<'a, u32, CONFIG_SPEC, bool, 8>;
...
pub type INSYNC_W<'a> = crate::FieldWriter<'a, u32, CONFIG_SPEC, u8, u8, 4, 9>;
...
pub type AUTOLIMIT_L_W<'a> = crate::BitWriter<'a, u32, CONFIG_SPEC, bool, 17>;
...
pub type AUTOLIMIT_H_W<'a> = crate::BitWriter<'a, u32, CONFIG_SPEC, bool, 18>;
impl R {
