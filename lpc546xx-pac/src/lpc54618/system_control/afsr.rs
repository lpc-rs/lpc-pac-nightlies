...
pub type AUXFAULT_R = crate::FieldReader<u32, u32>;
#[doc = "Field `AUXFAULT` writer - Latched version of the AUXFAULT inputs"]
pub type AUXFAULT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AFSR_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:31 - Latched version of the AUXFAULT inputs"]
    #[inline(always)]
    pub fn auxfault(&mut self) -> AUXFAULT_W<0> {
        AUXFAULT_W::new(self)
    }
