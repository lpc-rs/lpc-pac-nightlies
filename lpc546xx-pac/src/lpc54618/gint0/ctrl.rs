...
pub type INT_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, INT_A, 0>;
impl<'a> INT_W<'a> {
...
pub type COMB_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, COMB_A, 1>;
impl<'a> COMB_W<'a> {
...
pub type TRIG_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, TRIG_A, 2>;
impl<'a> TRIG_W<'a> {
    #[doc = "Edge-triggered."]
    #[inline(always)]
