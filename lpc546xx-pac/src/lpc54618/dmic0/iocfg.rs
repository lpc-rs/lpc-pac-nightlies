...
pub type CLK_BYPASS0_W<'a> = crate::BitWriter<'a, u32, IOCFG_SPEC, bool, 0>;
...
pub type CLK_BYPASS1_W<'a> = crate::BitWriter<'a, u32, IOCFG_SPEC, bool, 1>;
...
pub type STEREO_DATA0_W<'a> = crate::BitWriter<'a, u32, IOCFG_SPEC, bool, 2>;
impl R {
