...
pub type TXDATA_W<'a> = crate::FieldWriter<'a, u32, FIFOWR_SPEC, u16, u16, 16, 0>;
...
pub type TXSSEL0_N_W<'a> = crate::BitWriter<'a, u32, FIFOWR_SPEC, TXSSEL0_N_AW, 16>;
...
pub type TXSSEL1_N_W<'a> = crate::BitWriter<'a, u32, FIFOWR_SPEC, TXSSEL1_N_AW, 17>;
...
pub type TXSSEL2_N_W<'a> = crate::BitWriter<'a, u32, FIFOWR_SPEC, TXSSEL2_N_AW, 18>;
...
pub type TXSSEL3_N_W<'a> = crate::BitWriter<'a, u32, FIFOWR_SPEC, TXSSEL3_N_AW, 19>;
...
pub type EOT_W<'a> = crate::BitWriter<'a, u32, FIFOWR_SPEC, EOT_AW, 20>;
impl<'a> EOT_W<'a> {
...
pub type EOF_W<'a> = crate::BitWriter<'a, u32, FIFOWR_SPEC, EOF_AW, 21>;
impl<'a> EOF_W<'a> {
...
pub type RXIGNORE_W<'a> = crate::BitWriter<'a, u32, FIFOWR_SPEC, RXIGNORE_AW, 22>;
impl<'a> RXIGNORE_W<'a> {
...
pub type LEN_W<'a> = crate::FieldWriter<'a, u32, FIFOWR_SPEC, u8, u8, 4, 24>;
impl R {
