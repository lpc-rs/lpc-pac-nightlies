...
pub type PERIPHREQEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, PERIPHREQEN_A, 0>;
...
pub type HWTRIGEN_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, HWTRIGEN_A, 1>;
impl<'a> HWTRIGEN_W<'a> {
...
pub type TRIGPOL_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, TRIGPOL_A, 4>;
impl<'a> TRIGPOL_W<'a> {
...
pub type TRIGTYPE_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, TRIGTYPE_A, 5>;
impl<'a> TRIGTYPE_W<'a> {
...
pub type TRIGBURST_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, TRIGBURST_A, 6>;
...
pub type BURSTPOWER_W<'a> = crate::FieldWriter<'a, u32, CFG_SPEC, u8, u8, 4, 8>;
...
pub type SRCBURSTWRAP_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, SRCBURSTWRAP_A, 14>;
...
pub type DSTBURSTWRAP_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, DSTBURSTWRAP_A, 15>;
...
pub type CHPRIORITY_W<'a> = crate::FieldWriter<'a, u32, CFG_SPEC, u8, u8, 3, 16>;
impl R {
