...
pub type GLBLUCAST_W<'a> = crate::BitWriter<'a, u32, MAC_PMT_CRTL_STAT_SPEC, bool, 9>;
...
pub type RWKPFE_W<'a> = crate::BitWriter<'a, u32, MAC_PMT_CRTL_STAT_SPEC, bool, 10>;
...
pub type RWKPTR_W<'a> = crate::FieldWriter<'a, u32, MAC_PMT_CRTL_STAT_SPEC, u8, u8, 5, 24>;
...
pub type RWKFILTRST_W<'a> = crate::BitWriter<'a, u32, MAC_PMT_CRTL_STAT_SPEC, bool, 31>;
impl R {
