...
pub type FTQ_W<'a> = crate::BitWriter<'a, u32, MTL_TXQX_OP_MODE_SPEC, bool, 0>;
...
pub type TSF_W<'a> = crate::BitWriter<'a, u32, MTL_TXQX_OP_MODE_SPEC, bool, 1>;
...
pub type TXQEN_W<'a> = crate::FieldWriter<'a, u32, MTL_TXQX_OP_MODE_SPEC, u8, u8, 2, 2>;
...
pub type TTC_W<'a> = crate::FieldWriter<'a, u32, MTL_TXQX_OP_MODE_SPEC, u8, u8, 3, 4>;
...
pub type TQS_W<'a> = crate::FieldWriter<'a, u32, MTL_TXQX_OP_MODE_SPEC, u8, u8, 3, 16>;
impl R {
