...
pub type EP_SET_INT_W<'a> = crate::FieldWriter<'a, u32, INTSETSTAT_SPEC, u16, u16, 12, 0>;
...
pub type FRAME_SET_INT_W<'a> = crate::BitWriter<'a, u32, INTSETSTAT_SPEC, bool, 30>;
...
pub type DEV_SET_INT_W<'a> = crate::BitWriter<'a, u32, INTSETSTAT_SPEC, bool, 31>;
impl R {
