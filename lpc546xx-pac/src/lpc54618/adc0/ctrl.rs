...
pub type CLKDIV_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 8, 0>;
...
pub type ASYNMODE_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, ASYNMODE_A, 8>;
impl<'a> ASYNMODE_W<'a> {
...
pub type RESOL_W<'a> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, RESOL_A, 2, 9>;
impl<'a> RESOL_W<'a> {
...
pub type BYPASSCAL_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, BYPASSCAL_A, 11>;
...
pub type TSAMP_W<'a> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 3, 12>;
impl R {
