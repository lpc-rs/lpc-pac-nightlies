...
pub type MR0I_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 0>;
...
pub type MR0R_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 1>;
...
will be set to 0 if MR0 matches the TC."]
pub type MR0S_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 2>;
...
pub type MR1I_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 3>;
...
pub type MR1R_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 4>;
...
will be set to 0 if MR1 matches the TC."]
pub type MR1S_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 5>;
...
pub type MR2I_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 6>;
...
pub type MR2R_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 7>;
...
will be set to 0 if MR2 matches the TC."]
pub type MR2S_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 8>;
...
pub type MR3I_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 9>;
...
pub type MR3R_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 10>;
...
will be set to 0 if MR3 matches the TC."]
pub type MR3S_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 11>;
...
pub type MR0RL_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 24>;
...
pub type MR1RL_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 25>;
...
pub type MR2RL_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 26>;
...
pub type MR3RL_W<'a> = crate::BitWriter<'a, u32, MCR_SPEC, bool, 27>;
impl R {
