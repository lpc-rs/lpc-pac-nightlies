...
pub type DIVSEL_W<'a> = crate::FieldWriter<'a, u32, WDTOSCCTRL_SPEC, u8, u8, 5, 0>;
#[doc = "Field `FREQSEL` reader - Frequency select."]
pub type FREQSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `FREQSEL` writer - Frequency select."]
pub type FREQSEL_W<'a> = crate::FieldWriter<'a, u32, WDTOSCCTRL_SPEC, u8, u8, 5, 5>;
impl R {
