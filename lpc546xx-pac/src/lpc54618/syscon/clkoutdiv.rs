...
pub type DIV_W<'a> = crate::FieldWriter<'a, u32, CLKOUTDIV_SPEC, u8, u8, 8, 0>;
...
pub type RESET_W<'a> = crate::BitWriter<'a, u32, CLKOUTDIV_SPEC, bool, 29>;
...
pub type HALT_W<'a> = crate::BitWriter<'a, u32, CLKOUTDIV_SPEC, bool, 30>;
...
pub type REQFLAG_W<'a> = crate::BitWriter<'a, u32, CLKOUTDIV_SPEC, bool, 31>;
impl R {
