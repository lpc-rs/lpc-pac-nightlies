...
pub type TFGI_W<'a> = crate::FieldWriter<'a, u32, TXFQS_SPEC, u8, u8, 5, 8>;
...
pub type TFQPI_W<'a> = crate::FieldWriter<'a, u32, TXFQS_SPEC, u8, u8, 5, 16>;
#[doc = "Field `TFQF` reader - Tx FIFO/queue full."]
pub type TFQF_R = crate::BitReader<bool>;
#[doc = "Field `TFQF` writer - Tx FIFO/queue full."]
pub type TFQF_W<'a> = crate::BitWriter<'a, u32, TXFQS_SPEC, bool, 21>;
impl R {
