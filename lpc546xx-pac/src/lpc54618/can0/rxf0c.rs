...
pub type F0SA_W<'a> = crate::FieldWriter<'a, u32, RXF0C_SPEC, u16, u16, 14, 2>;
#[doc = "Field `F0S` reader - Rx FIFO 0 size."]
pub type F0S_R = crate::FieldReader<u8, u8>;
#[doc = "Field `F0S` writer - Rx FIFO 0 size."]
pub type F0S_W<'a> = crate::FieldWriter<'a, u32, RXF0C_SPEC, u8, u8, 7, 16>;
...
pub type F0WM_W<'a> = crate::FieldWriter<'a, u32, RXF0C_SPEC, u8, u8, 7, 24>;
...
pub type F0OM_W<'a> = crate::BitWriter<'a, u32, RXF0C_SPEC, bool, 31>;
impl R {
