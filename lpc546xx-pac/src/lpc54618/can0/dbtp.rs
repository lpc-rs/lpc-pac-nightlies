...
pub type DSJW_W<'a> = crate::FieldWriter<'a, u32, DBTP_SPEC, u8, u8, 4, 0>;
...
pub type DTSEG2_W<'a> = crate::FieldWriter<'a, u32, DBTP_SPEC, u8, u8, 4, 4>;
...
pub type DTSEG1_W<'a> = crate::FieldWriter<'a, u32, DBTP_SPEC, u8, u8, 5, 8>;
...
pub type DBRP_W<'a> = crate::FieldWriter<'a, u32, DBTP_SPEC, u8, u8, 5, 16>;
...
pub type TDC_W<'a> = crate::BitWriter<'a, u32, DBTP_SPEC, bool, 23>;
impl R {
