...
pub type CMD_INDEX_W<'a> = crate::FieldWriter<'a, u32, CMD_SPEC, u8, u8, 6, 0>;
...
pub type RESPONSE_EXPECT_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 6>;
...
pub type RESPONSE_LENGTH_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 7>;
...
pub type CHECK_RESPONSE_CRC_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 8>;
...
pub type DATA_EXPECTED_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 9>;
#[doc = "Field `READ_WRITE` reader - read/write."]
pub type READ_WRITE_R = crate::BitReader<bool>;
#[doc = "Field `READ_WRITE` writer - read/write."]
pub type READ_WRITE_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 10>;
...
pub type TRANSFER_MODE_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 11>;
...
pub type SEND_AUTO_STOP_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 12>;
...
pub type WAIT_PRVDATA_COMPLETE_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 13>;
...
pub type STOP_ABORT_CMD_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 14>;
...
pub type SEND_INITIALIZATION_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 15>;
...
pub type UPDATE_CLOCK_REGISTERS_ONLY_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 21>;
...
pub type READ_CEATA_DEVICE_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 22>;
...
pub type CCS_EXPECTED_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 23>;
...
pub type ENABLE_BOOT_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 24>;
...
pub type EXPECT_BOOT_ACK_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 25>;
...
pub type DISABLE_BOOT_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 26>;
#[doc = "Field `BOOT_MODE` reader - Boot Mode."]
pub type BOOT_MODE_R = crate::BitReader<bool>;
#[doc = "Field `BOOT_MODE` writer - Boot Mode."]
pub type BOOT_MODE_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 27>;
...
pub type VOLT_SWITCH_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 28>;
...
pub type USE_HOLD_REG_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 29>;
...
pub type START_CMD_W<'a> = crate::BitWriter<'a, u32, CMD_SPEC, bool, 31>;
impl R {
