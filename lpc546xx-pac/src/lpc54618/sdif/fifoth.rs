...
pub type TX_WMARK_W<'a> = crate::FieldWriter<'a, u32, FIFOTH_SPEC, u16, u16, 12, 0>;
...
pub type RX_WMARK_W<'a> = crate::FieldWriter<'a, u32, FIFOTH_SPEC, u16, u16, 12, 16>;
...
pub type DMA_MTS_R = crate::FieldReader<u8, u8>;
...
pub type DMA_MTS_W<'a> = crate::FieldWriter<'a, u32, FIFOTH_SPEC, u8, u8, 3, 28>;
impl R {
    ...
    pub fn dma_mts(&self) -> DMA_MTS_R {
        DMA_MTS_R::new(((self.bits >> 28) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 0:11 - FIFO threshold watermark level when transmitting data to card."]
