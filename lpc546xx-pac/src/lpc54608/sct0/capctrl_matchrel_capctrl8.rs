...
pub type CAPCONN_L_W<'a> =
    crate::FieldWriter<'a, u32, CAPCTRL_MATCHREL_CAPCTRL8_SPEC, u16, u16, 16, 0>;
...
pub type CAPCONN_H_W<'a> =
    crate::FieldWriter<'a, u32, CAPCTRL_MATCHREL_CAPCTRL8_SPEC, u16, u16, 16, 16>;
impl R {
