...
pub type PCD_LO_W<'a> = crate::FieldWriter<'a, u32, POL_SPEC, u8, u8, 5, 0>;
...
pub type ACB_W<'a> = crate::FieldWriter<'a, u32, POL_SPEC, u8, u8, 5, 6>;
...
pub type IVS_W<'a> = crate::BitWriter<'a, u32, POL_SPEC, bool, 11>;
...
pub type BCD_W<'a> = crate::BitWriter<'a, u32, POL_SPEC, bool, 26>;
...
pub type PCD_HI_W<'a> = crate::FieldWriter<'a, u32, POL_SPEC, u8, u8, 5, 27>;
impl R {
