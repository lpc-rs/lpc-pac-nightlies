...
pub type RED_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CRSR_PAL1_SPEC, u8, u8, 8, O>;
...
pub type GREEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CRSR_PAL1_SPEC, u8, u8, 8, O>;
...
pub type BLUE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CRSR_PAL1_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[doc = "Bits 16:23 - Blue color component."]
    #[inline(always)]
    pub fn blue(&mut self) -> BLUE_W<16> {
        BLUE_W::new(self)
    }
