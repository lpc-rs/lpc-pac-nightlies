...
pub type PPL_W<'a> = crate::FieldWriter<'a, u32, TIMH_SPEC, u8, u8, 6, 2>;
...
pub type HSW_W<'a> = crate::FieldWriter<'a, u32, TIMH_SPEC, u8, u8, 8, 8>;
...
pub type HFP_W<'a> = crate::FieldWriter<'a, u32, TIMH_SPEC, u8, u8, 8, 16>;
...
pub type HBP_W<'a> = crate::FieldWriter<'a, u32, TIMH_SPEC, u8, u8, 8, 24>;
impl R {
