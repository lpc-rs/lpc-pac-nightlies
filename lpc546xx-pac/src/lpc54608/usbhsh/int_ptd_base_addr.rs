...
pub type INT_FIRST_W<'a> = crate::FieldWriter<'a, u32, INT_PTD_BASE_ADDR_SPEC, u8, u8, 5, 5>;
...
pub type INT_BASE_W<'a> = crate::FieldWriter<'a, u32, INT_PTD_BASE_ADDR_SPEC, u32, u32, 22, 10>;
impl R {
