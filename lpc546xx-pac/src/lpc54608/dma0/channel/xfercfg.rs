...
pub type CFGVALID_W<'a> = crate::BitWriter<'a, u32, XFERCFG_SPEC, CFGVALID_A, 0>;
impl<'a> CFGVALID_W<'a> {
...
pub type RELOAD_W<'a> = crate::BitWriter<'a, u32, XFERCFG_SPEC, RELOAD_A, 1>;
impl<'a> RELOAD_W<'a> {
...
pub type SWTRIG_W<'a> = crate::BitWriter<'a, u32, XFERCFG_SPEC, SWTRIG_A, 2>;
impl<'a> SWTRIG_W<'a> {
...
pub type CLRTRIG_W<'a> = crate::BitWriter<'a, u32, XFERCFG_SPEC, CLRTRIG_A, 3>;
impl<'a> CLRTRIG_W<'a> {
...
pub type SETINTA_W<'a> = crate::BitWriter<'a, u32, XFERCFG_SPEC, SETINTA_A, 4>;
impl<'a> SETINTA_W<'a> {
    #[doc = "No effect."]
    #[inline(always)]
...
pub type SETINTB_W<'a> = crate::BitWriter<'a, u32, XFERCFG_SPEC, SETINTB_A, 5>;
impl<'a> SETINTB_W<'a> {
    #[doc = "No effect."]
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut W {
...
pub type WIDTH_W<'a> = crate::FieldWriter<'a, u32, XFERCFG_SPEC, u8, WIDTH_A, 2, 8>;
impl<'a> WIDTH_W<'a> {
...
pub type SRCINC_W<'a> = crate::FieldWriterSafe<'a, u32, XFERCFG_SPEC, u8, SRCINC_A, 2, 12>;
impl<'a> SRCINC_W<'a> {
...
pub type DSTINC_W<'a> = crate::FieldWriterSafe<'a, u32, XFERCFG_SPEC, u8, DSTINC_A, 2, 14>;
impl<'a> DSTINC_W<'a> {
...
pub type XFERCOUNT_W<'a> = crate::FieldWriter<'a, u32, XFERCFG_SPEC, u16, u16, 10, 16>;
impl R {
