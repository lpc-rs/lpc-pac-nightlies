...
pub type FUNC_W<'a> = crate::FieldWriter<'a, u32, PIO015_SPEC, u8, FUNC_A, 4, 0>;
impl<'a> FUNC_W<'a> {
...
pub type MODE_W<'a> = crate::FieldWriterSafe<'a, u32, PIO015_SPEC, u8, MODE_A, 2, 4>;
impl<'a> MODE_W<'a> {
...
pub type INVERT_W<'a> = crate::BitWriter<'a, u32, PIO015_SPEC, INVERT_A, 7>;
impl<'a> INVERT_W<'a> {
...
pub type DIGIMODE_W<'a> = crate::BitWriter<'a, u32, PIO015_SPEC, DIGIMODE_A, 8>;
impl<'a> DIGIMODE_W<'a> {
    #[doc = "Analog mode."]
    #[inline(always)]
...
pub type FILTEROFF_W<'a> = crate::BitWriter<'a, u32, PIO015_SPEC, FILTEROFF_A, 9>;
...
pub type OD_W<'a> = crate::BitWriter<'a, u32, PIO015_SPEC, OD_A, 11>;
impl<'a> OD_W<'a> {
