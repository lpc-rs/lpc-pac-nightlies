...
pub type LPIEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_LPI_CTRL_STAT_SPEC, bool, O>;
...
pub type PLS_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_LPI_CTRL_STAT_SPEC, bool, O>;
...
pub type LPITXA_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_LPI_CTRL_STAT_SPEC, bool, O>;
...
pub type LPIATE_R = crate::BitReader<bool>;
...
pub type LPIATE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_LPI_CTRL_STAT_SPEC, bool, O>;
...
pub type LPITCSE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_LPI_CTRL_STAT_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 20 - LPI Timer Enable This bit controls the automatic entry of the MAC Transmitter into and exit out of the LPI state."]
    #[inline(always)]
    pub fn lpiate(&mut self) -> LPIATE_W<20> {
        LPIATE_W::new(self)
    }
    #[doc = "Bit 21 - LPI Tx Clock Stop Enable When this bit is set, the MAC asserts LPI Tx Clock Gating Control signal high after it enters Tx LPI mode to indicate that the Tx clock to MAC can be stopped."]
    #[inline(always)]
