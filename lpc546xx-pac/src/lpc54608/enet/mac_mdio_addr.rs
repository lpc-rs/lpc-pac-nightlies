...
pub type MB_W<'a> = crate::BitWriter<'a, u32, MAC_MDIO_ADDR_SPEC, bool, 0>;
...
pub type MOC_W<'a> = crate::FieldWriter<'a, u32, MAC_MDIO_ADDR_SPEC, u8, u8, 2, 2>;
#[doc = "Field `CR` reader - CSR Clock Range."]
pub type CR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CR` writer - CSR Clock Range."]
pub type CR_W<'a> = crate::FieldWriter<'a, u32, MAC_MDIO_ADDR_SPEC, u8, u8, 4, 8>;
...
pub type NTC_W<'a> = crate::FieldWriter<'a, u32, MAC_MDIO_ADDR_SPEC, u8, u8, 3, 12>;
...
pub type RDA_W<'a> = crate::FieldWriter<'a, u32, MAC_MDIO_ADDR_SPEC, u8, u8, 5, 16>;
...
pub type PA_W<'a> = crate::FieldWriter<'a, u32, MAC_MDIO_ADDR_SPEC, u8, u8, 5, 21>;
...
pub type BTB_W<'a> = crate::BitWriter<'a, u32, MAC_MDIO_ADDR_SPEC, bool, 26>;
...
pub type PSE_W<'a> = crate::BitWriter<'a, u32, MAC_MDIO_ADDR_SPEC, bool, 27>;
impl R {
    #[doc = "Bit 0 - MII busy."]
    #[inline(always)]
    pub fn mb(&self) -> MB_R {
