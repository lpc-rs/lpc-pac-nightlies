...
pub type DTXSTS_W<'a> = crate::BitWriter<'a, u32, MTL_OP_MODE_SPEC, bool, 1>;
...
pub type SCHALG_W<'a> = crate::FieldWriter<'a, u32, MTL_OP_MODE_SPEC, u8, u8, 2, 5>;
...
pub type CNTPRST_W<'a> = crate::BitWriter<'a, u32, MTL_OP_MODE_SPEC, bool, 8>;
...
pub type CNTCLR_W<'a> = crate::BitWriter<'a, u32, MTL_OP_MODE_SPEC, bool, 9>;
impl R {
