...
pub type SWRESET_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, SWRESET_A, 0>;
impl<'a> SWRESET_W<'a> {
...
pub type ALARM1HZ_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, ALARM1HZ_A, 2>;
impl<'a> ALARM1HZ_W<'a> {
...
pub type WAKE1KHZ_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, WAKE1KHZ_A, 3>;
impl<'a> WAKE1KHZ_W<'a> {
...
pub type ALARMDPD_EN_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, ALARMDPD_EN_A, 4>;
...
pub type WAKEDPD_EN_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, WAKEDPD_EN_A, 5>;
...
pub type RTC1KHZ_EN_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, RTC1KHZ_EN_A, 6>;
...
pub type RTC_EN_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, RTC_EN_A, 7>;
impl<'a> RTC_EN_W<'a> {
...
pub type RTC_OSC_PD_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, RTC_OSC_PD_A, 8>;
