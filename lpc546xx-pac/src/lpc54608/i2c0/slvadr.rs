...
pub type SADISABLE_W<'a> = crate::BitWriter<'a, u32, SLVADR_SPEC, SADISABLE_A, 0>;
...
pub type SLVADR_W<'a> = crate::FieldWriter<'a, u32, SLVADR_SPEC, u8, u8, 7, 1>;
...
pub type AUTONACK_W<'a> = crate::BitWriter<'a, u32, SLVADR_SPEC, AUTONACK_A, 15>;
impl<'a> AUTONACK_W<'a> {
