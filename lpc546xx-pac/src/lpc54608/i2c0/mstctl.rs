...
pub type MSTCONTINUE_W<'a> = crate::BitWriter<'a, u32, MSTCTL_SPEC, MSTCONTINUE_AW, 0>;
...
pub type MSTSTART_W<'a> = crate::BitWriter<'a, u32, MSTCTL_SPEC, MSTSTART_A, 1>;
impl<'a> MSTSTART_W<'a> {
    #[doc = "No effect."]
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut W {
...
pub type MSTSTOP_W<'a> = crate::BitWriter<'a, u32, MSTCTL_SPEC, MSTSTOP_A, 2>;
impl<'a> MSTSTOP_W<'a> {
    #[doc = "No effect."]
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut W {
...
pub type MSTDMA_W<'a> = crate::BitWriter<'a, u32, MSTCTL_SPEC, MSTDMA_A, 3>;
impl<'a> MSTDMA_W<'a> {
