...
pub type HCR_W<'a> = crate::BitWriter<'a, u32, HCCOMMANDSTATUS_SPEC, bool, 0>;
...
pub type CLF_W<'a> = crate::BitWriter<'a, u32, HCCOMMANDSTATUS_SPEC, bool, 1>;
...
pub type BLF_W<'a> = crate::BitWriter<'a, u32, HCCOMMANDSTATUS_SPEC, bool, 2>;
...
pub type OCR_W<'a> = crate::BitWriter<'a, u32, HCCOMMANDSTATUS_SPEC, bool, 3>;
...
pub type SOC_W<'a> = crate::FieldWriter<'a, u32, HCCOMMANDSTATUS_SPEC, u8, u8, 2, 6>;
impl R {
