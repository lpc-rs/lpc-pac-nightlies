...
pub type GFLAG0_W<'a> = crate::BitWriter<'a, u32, IRQ_FLAG_SPEC, GFLAG0_A, 0>;
impl<'a> GFLAG0_W<'a> {
...
pub type GFLAG1_W<'a> = crate::BitWriter<'a, u32, IRQ_FLAG_SPEC, bool, 1>;
...
pub type GFLAG2_W<'a> = crate::BitWriter<'a, u32, IRQ_FLAG_SPEC, bool, 2>;
...
pub type GFLAG3_W<'a> = crate::BitWriter<'a, u32, IRQ_FLAG_SPEC, bool, 3>;
impl R {
