...
pub type TXIDLECLR_W<'a> = crate::BitWriter<'a, u32, INTENCLR_SPEC, bool, 3>;
...
pub type TXDISCLR_W<'a> = crate::BitWriter<'a, u32, INTENCLR_SPEC, bool, 6>;
...
pub type ABERRCLR_W<'a> = crate::BitWriter<'a, u32, INTENCLR_SPEC, bool, 16>;
impl W {
