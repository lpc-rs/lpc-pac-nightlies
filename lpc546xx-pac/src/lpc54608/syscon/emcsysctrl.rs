...
pub type EMCSC_W<'a> = crate::BitWriter<'a, u32, EMCSYSCTRL_SPEC, bool, 0>;
#[doc = "Field `EMCRD` reader - EMC Reset Disable."]
pub type EMCRD_R = crate::BitReader<bool>;
#[doc = "Field `EMCRD` writer - EMC Reset Disable."]
pub type EMCRD_W<'a> = crate::BitWriter<'a, u32, EMCSYSCTRL_SPEC, bool, 1>;
...
pub type EMCBC_W<'a> = crate::BitWriter<'a, u32, EMCSYSCTRL_SPEC, bool, 2>;
...
pub type EMCFBCLKINSEL_W<'a> = crate::BitWriter<'a, u32, EMCSYSCTRL_SPEC, bool, 3>;
impl R {
