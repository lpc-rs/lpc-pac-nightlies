...
pub type SELR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AUDPLLCTRL_SPEC, u8, u8, 4, O>;
...
pub type SELI_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AUDPLLCTRL_SPEC, u8, u8, 6, O>;
#[doc = "Field `SELP` reader - ."]
pub type SELP_R = crate::FieldReader<u8, u8>;
#[doc = "Field `SELP` writer - ."]
pub type SELP_W<'a, const O: u8> = crate::FieldWriter<'a, u32, AUDPLLCTRL_SPEC, u8, u8, 5, O>;
...
pub type BYPASS_W<'a, const O: u8> = crate::BitWriter<'a, u32, AUDPLLCTRL_SPEC, BYPASS_A, O>;
...
pub type UPLIMOFF_W<'a, const O: u8> = crate::BitWriter<'a, u32, AUDPLLCTRL_SPEC, bool, O>;
...
pub type DIRECTI_W<'a, const O: u8> = crate::BitWriter<'a, u32, AUDPLLCTRL_SPEC, bool, O>;
...
pub type DIRECTO_W<'a, const O: u8> = crate::BitWriter<'a, u32, AUDPLLCTRL_SPEC, DIRECTO_A, O>;
