...
pub type SELR_W<'a> = crate::FieldWriter<'a, u32, SYSPLLCTRL_SPEC, u8, u8, 4, 0>;
...
pub type SELI_W<'a> = crate::FieldWriter<'a, u32, SYSPLLCTRL_SPEC, u8, u8, 6, 4>;
...
pub type SELP_W<'a> = crate::FieldWriter<'a, u32, SYSPLLCTRL_SPEC, u8, u8, 5, 10>;
...
pub type BYPASS_W<'a> = crate::BitWriter<'a, u32, SYSPLLCTRL_SPEC, BYPASS_A, 15>;
impl<'a> BYPASS_W<'a> {
...
pub type UPLIMOFF_W<'a> = crate::BitWriter<'a, u32, SYSPLLCTRL_SPEC, bool, 17>;
...
pub type DIRECTI_W<'a> = crate::BitWriter<'a, u32, SYSPLLCTRL_SPEC, bool, 19>;
...
pub type DIRECTO_W<'a> = crate::BitWriter<'a, u32, SYSPLLCTRL_SPEC, DIRECTO_A, 20>;
impl<'a> DIRECTO_W<'a> {
