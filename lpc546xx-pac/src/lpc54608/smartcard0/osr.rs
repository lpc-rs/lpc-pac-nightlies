...
pub type OSFRAC_W<'a> = crate::FieldWriter<'a, u32, OSR_SPEC, u8, u8, 3, 1>;
...
pub type OSINT_W<'a> = crate::FieldWriter<'a, u32, OSR_SPEC, u8, u8, 4, 4>;
...
pub type FDINT_W<'a> = crate::FieldWriter<'a, u32, OSR_SPEC, u8, u8, 7, 8>;
impl R {
