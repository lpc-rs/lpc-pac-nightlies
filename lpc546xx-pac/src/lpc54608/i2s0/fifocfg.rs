...
pub type ENABLETX_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, ENABLETX_A, 0>;
impl<'a> ENABLETX_W<'a> {
...
pub type ENABLERX_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, ENABLERX_A, 1>;
impl<'a> ENABLERX_W<'a> {
...
pub type TXI2SE0_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, TXI2SE0_A, 2>;
impl<'a> TXI2SE0_W<'a> {
...
pub type PACK48_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, PACK48_A, 3>;
impl<'a> PACK48_W<'a> {
...
pub type DMATX_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, DMATX_A, 12>;
impl<'a> DMATX_W<'a> {
...
pub type DMARX_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, DMARX_A, 13>;
impl<'a> DMARX_W<'a> {
...
pub type WAKETX_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, WAKETX_A, 14>;
impl<'a> WAKETX_W<'a> {
...
pub type WAKERX_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, WAKERX_A, 15>;
impl<'a> WAKERX_W<'a> {
    #[doc = "Only enabled interrupts will wake up the device form reduced power modes."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type EMPTYTX_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, bool, 16>;
...
pub type EMPTYRX_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, bool, 17>;
...
pub type POPDBG_W<'a> = crate::BitWriter<'a, u32, FIFOCFG_SPEC, POPDBG_A, 18>;
impl<'a> POPDBG_W<'a> {
