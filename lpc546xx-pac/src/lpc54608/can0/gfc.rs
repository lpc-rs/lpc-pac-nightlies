...
pub type RRFE_W<'a> = crate::BitWriter<'a, u32, GFC_SPEC, bool, 0>;
...
pub type RRFS_W<'a> = crate::BitWriter<'a, u32, GFC_SPEC, bool, 1>;
...
pub type ANFE_W<'a> = crate::FieldWriter<'a, u32, GFC_SPEC, u8, u8, 2, 2>;
...
pub type ANFS_W<'a> = crate::FieldWriter<'a, u32, GFC_SPEC, u8, u8, 2, 4>;
impl R {
