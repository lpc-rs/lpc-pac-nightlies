...
pub type NONBASETHRDENA_W<'a> = crate::BitWriter<'a, u32, CCR_SPEC, NONBASETHRDENA_A, 0>;
...
pub type USERSETMPEND_W<'a> = crate::BitWriter<'a, u32, CCR_SPEC, USERSETMPEND_A, 1>;
...
pub type UNALIGN_TRP_W<'a> = crate::BitWriter<'a, u32, CCR_SPEC, UNALIGN_TRP_A, 3>;
...
pub type DIV_0_TRP_W<'a> = crate::BitWriter<'a, u32, CCR_SPEC, DIV_0_TRP_A, 4>;
...
pub type BFHFNMIGN_W<'a> = crate::BitWriter<'a, u32, CCR_SPEC, BFHFNMIGN_A, 8>;
...
pub type STKALIGN_W<'a> = crate::BitWriter<'a, u32, CCR_SPEC, STKALIGN_A, 9>;
impl<'a> STKALIGN_W<'a> {
    #[doc = "4-byte aligned"]
    #[inline(always)]
