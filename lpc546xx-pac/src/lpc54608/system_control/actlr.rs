...
pub type DISMCYCINT_W<'a> = crate::BitWriter<'a, u32, ACTLR_SPEC, bool, 0>;
...
pub type DISDEFWBUF_W<'a> = crate::BitWriter<'a, u32, ACTLR_SPEC, bool, 1>;
...
pub type DISFOLD_W<'a> = crate::BitWriter<'a, u32, ACTLR_SPEC, bool, 2>;
impl R {
