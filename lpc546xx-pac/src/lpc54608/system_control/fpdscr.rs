...
pub type RMODE_W<'a> = crate::FieldWriterSafe<'a, u32, FPDSCR_SPEC, u8, RMODE_A, 2, 22>;
impl<'a> RMODE_W<'a> {
...
pub type FZ_W<'a> = crate::BitWriter<'a, u32, FPDSCR_SPEC, FZ_A, 24>;
impl<'a> FZ_W<'a> {
...
pub type DN_W<'a> = crate::BitWriter<'a, u32, FPDSCR_SPEC, DN_A, 25>;
impl<'a> DN_W<'a> {
...
pub type AHP_W<'a> = crate::BitWriter<'a, u32, FPDSCR_SPEC, AHP_A, 26>;
impl<'a> AHP_W<'a> {
