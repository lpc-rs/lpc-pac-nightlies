...
pub type LSPACT_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, LSPACT_A, 0>;
impl<'a> LSPACT_W<'a> {
...
pub type USER_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, USER_A, 1>;
impl<'a> USER_W<'a> {
...
pub type THREAD_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, THREAD_A, 3>;
impl<'a> THREAD_W<'a> {
...
pub type HFRDY_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, HFRDY_A, 4>;
impl<'a> HFRDY_W<'a> {
...
pub type MMRDY_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, MMRDY_A, 5>;
impl<'a> MMRDY_W<'a> {
...
pub type BFRDY_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, BFRDY_A, 6>;
impl<'a> BFRDY_W<'a> {
...
pub type MONRDY_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, MONRDY_A, 8>;
impl<'a> MONRDY_W<'a> {
...
pub type LSPEN_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, LSPEN_A, 30>;
impl<'a> LSPEN_W<'a> {
...
pub type ASPEN_W<'a> = crate::BitWriter<'a, u32, FPCCR_SPEC, ASPEN_A, 31>;
impl<'a> ASPEN_W<'a> {
