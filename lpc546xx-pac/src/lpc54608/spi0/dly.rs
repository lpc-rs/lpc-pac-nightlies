...
pub type PRE_DELAY_W<'a> = crate::FieldWriter<'a, u32, DLY_SPEC, u8, u8, 4, 0>;
...
pub type POST_DELAY_W<'a> = crate::FieldWriter<'a, u32, DLY_SPEC, u8, u8, 4, 4>;
...
pub type FRAME_DELAY_W<'a> = crate::FieldWriter<'a, u32, DLY_SPEC, u8, u8, 4, 8>;
...
pub type TRANSFER_DELAY_W<'a> = crate::FieldWriter<'a, u32, DLY_SPEC, u8, u8, 4, 12>;
impl R {
