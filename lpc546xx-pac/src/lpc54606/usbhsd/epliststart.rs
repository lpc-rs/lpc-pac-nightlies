...
pub type EP_LIST_PRG_R = crate::FieldReader<u16, u16>;
#[doc = "Field `EP_LIST_PRG` writer - Programmable portion of the USB EP Command/Status List address."]
pub type EP_LIST_PRG_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, EPLISTSTART_SPEC, u16, u16, 12, O>;
#[doc = "Field `EP_LIST_FIXED` reader - Fixed portion of USB EP Command/Status List address."]
pub type EP_LIST_FIXED_R = crate::FieldReader<u16, u16>;
impl R {
...
impl W {
    #[doc = "Bits 8:19 - Programmable portion of the USB EP Command/Status List address."]
    #[inline(always)]
    pub fn ep_list_prg(&mut self) -> EP_LIST_PRG_W<8> {
        EP_LIST_PRG_W::new(self)
    }
