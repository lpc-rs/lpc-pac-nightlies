...
pub type DCPOLE_W<'a> = crate::FieldWriterSafe<'a, u32, DC_CTRL_SPEC, u8, DCPOLE_A, 2, 0>;
impl<'a> DCPOLE_W<'a> {
...
pub type DCGAIN_W<'a> = crate::FieldWriter<'a, u32, DC_CTRL_SPEC, u8, u8, 4, 4>;
...
pub type SATURATEAT16BIT_W<'a> = crate::BitWriter<'a, u32, DC_CTRL_SPEC, SATURATEAT16BIT_A, 8>;
