...
pub type SLVCONTINUE_W<'a> = crate::BitWriter<'a, u32, SLVCTL_SPEC, SLVCONTINUE_A, 0>;
...
pub type SLVNACK_W<'a> = crate::BitWriter<'a, u32, SLVCTL_SPEC, SLVNACK_A, 1>;
impl<'a> SLVNACK_W<'a> {
    #[doc = "No effect."]
    #[inline(always)]
    pub fn no_effect(self) -> &'a mut W {
...
pub type SLVDMA_W<'a> = crate::BitWriter<'a, u32, SLVCTL_SPEC, SLVDMA_A, 3>;
impl<'a> SLVDMA_W<'a> {
...
pub type AUTOACK_W<'a> = crate::BitWriter<'a, u32, SLVCTL_SPEC, AUTOACK_A, 8>;
impl<'a> AUTOACK_W<'a> {
...
pub type AUTOMATCHREAD_W<'a> = crate::BitWriter<'a, u32, SLVCTL_SPEC, AUTOMATCHREAD_A, 9>;
