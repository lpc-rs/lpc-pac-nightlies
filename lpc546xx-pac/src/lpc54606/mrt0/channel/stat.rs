...
pub type INTFLAG_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, INTFLAG_A, 0>;
impl<'a> INTFLAG_W<'a> {
...
pub type RUN_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, RUN_A, 1>;
impl<'a> RUN_W<'a> {
...
pub type INUSE_W<'a> = crate::BitWriter<'a, u32, STAT_SPEC, INUSE_A, 2>;
impl<'a> INUSE_W<'a> {
