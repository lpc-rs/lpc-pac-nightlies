...
pub type SCIEN_W<'a> = crate::BitWriter<'a, u32, SCICTRL_SPEC, bool, 0>;
...
pub type NACKDIS_W<'a> = crate::BitWriter<'a, u32, SCICTRL_SPEC, bool, 1>;
...
pub type PROTSEL_W<'a> = crate::BitWriter<'a, u32, SCICTRL_SPEC, bool, 2>;
...
pub type TXRETRY_W<'a> = crate::FieldWriter<'a, u32, SCICTRL_SPEC, u8, u8, 3, 5>;
...
pub type GUARDTIME_W<'a> = crate::FieldWriter<'a, u32, SCICTRL_SPEC, u8, u8, 8, 8>;
impl R {
