...
pub type FIFOEN_W<'a> = crate::BitWriter<'a, u32, IIR_FCR_FCR_SPEC, bool, 0>;
#[doc = "Field `RXFIFORES` writer - RX FIFO Reset."]
pub type RXFIFORES_W<'a> = crate::BitWriter<'a, u32, IIR_FCR_FCR_SPEC, bool, 1>;
#[doc = "Field `TXFIFORES` writer - TX FIFO Reset."]
pub type TXFIFORES_W<'a> = crate::BitWriter<'a, u32, IIR_FCR_FCR_SPEC, bool, 2>;
#[doc = "Field `DMAMODE` writer - DMA Mode Select."]
pub type DMAMODE_W<'a> = crate::BitWriter<'a, u32, IIR_FCR_FCR_SPEC, bool, 3>;
#[doc = "Field `RXTRIGLVL` writer - RX Trigger Level."]
pub type RXTRIGLVL_W<'a> = crate::FieldWriter<'a, u32, IIR_FCR_FCR_SPEC, u8, u8, 2, 6>;
impl W {
