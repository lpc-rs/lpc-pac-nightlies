...
pub type CALIB_W<'a> = crate::BitWriter<'a, u32, CALIB_SPEC, bool, 0>;
...
pub type CALREQD_W<'a> = crate::BitWriter<'a, u32, CALIB_SPEC, bool, 1>;
...
pub type CALVALUE_W<'a> = crate::FieldWriter<'a, u32, CALIB_SPEC, u8, u8, 7, 2>;
impl R {
