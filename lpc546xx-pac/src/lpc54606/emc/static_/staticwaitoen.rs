...
pub type WAITOEN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `WAITOEN` writer - Wait output enable."]
pub type WAITOEN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, STATICWAITOEN_SPEC, u8, u8, 4, O>;
impl R {
...
impl W {
    #[doc = "Bits 0:3 - Wait output enable."]
    #[inline(always)]
    pub fn waitoen(&mut self) -> WAITOEN_W<0> {
        WAITOEN_W::new(self)
    }
