...
pub type NTSEG2_W<'a> = crate::FieldWriter<'a, u32, NBTP_SPEC, u8, u8, 7, 0>;
...
pub type NTSEG1_W<'a> = crate::FieldWriter<'a, u32, NBTP_SPEC, u8, u8, 8, 8>;
...
pub type NBRP_W<'a> = crate::FieldWriter<'a, u32, NBTP_SPEC, u16, u16, 9, 16>;
...
pub type NSJW_W<'a> = crate::FieldWriter<'a, u32, NBTP_SPEC, u8, u8, 7, 25>;
impl R {
