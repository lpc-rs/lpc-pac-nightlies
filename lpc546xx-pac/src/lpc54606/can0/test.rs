...
pub type LBCK_W<'a> = crate::BitWriter<'a, u32, TEST_SPEC, bool, 4>;
...
pub type TX_W<'a> = crate::FieldWriter<'a, u32, TEST_SPEC, u8, u8, 2, 5>;
...
pub type RX_W<'a> = crate::BitWriter<'a, u32, TEST_SPEC, bool, 7>;
impl R {
