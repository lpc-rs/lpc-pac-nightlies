...
pub type TBSA_W<'a> = crate::FieldWriter<'a, u32, TXBC_SPEC, u16, u16, 14, 2>;
...
pub type NDTB_W<'a> = crate::FieldWriter<'a, u32, TXBC_SPEC, u8, u8, 6, 16>;
...
pub type TFQS_W<'a> = crate::FieldWriter<'a, u32, TXBC_SPEC, u8, u8, 6, 24>;
#[doc = "Field `TFQM` reader - Tx FIFO/queue mode."]
pub type TFQM_R = crate::BitReader<bool>;
#[doc = "Field `TFQM` writer - Tx FIFO/queue mode."]
pub type TFQM_W<'a> = crate::BitWriter<'a, u32, TXBC_SPEC, bool, 30>;
impl R {
