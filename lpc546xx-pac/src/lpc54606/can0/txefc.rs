...
pub type EFSA_W<'a> = crate::FieldWriter<'a, u32, TXEFC_SPEC, u16, u16, 14, 2>;
...
pub type EFS_W<'a> = crate::FieldWriter<'a, u32, TXEFC_SPEC, u8, u8, 6, 16>;
...
pub type EFWM_W<'a> = crate::FieldWriter<'a, u32, TXEFC_SPEC, u8, u8, 6, 24>;
impl R {
