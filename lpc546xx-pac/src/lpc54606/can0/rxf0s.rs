...
pub type F0FL_W<'a> = crate::FieldWriter<'a, u32, RXF0S_SPEC, u8, u8, 7, 0>;
...
pub type F0GI_W<'a> = crate::FieldWriter<'a, u32, RXF0S_SPEC, u8, u8, 6, 8>;
...
pub type F0PI_W<'a> = crate::FieldWriter<'a, u32, RXF0S_SPEC, u8, u8, 6, 16>;
#[doc = "Field `F0F` reader - Rx FIFO 0 full."]
pub type F0F_R = crate::BitReader<bool>;
#[doc = "Field `F0F` writer - Rx FIFO 0 full."]
pub type F0F_W<'a> = crate::BitWriter<'a, u32, RXF0S_SPEC, bool, 24>;
...
pub type RF0L_W<'a> = crate::BitWriter<'a, u32, RXF0S_SPEC, bool, 25>;
impl R {
