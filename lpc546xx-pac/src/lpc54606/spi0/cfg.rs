...
pub type MASTER_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, MASTER_A, 2>;
impl<'a> MASTER_W<'a> {
...
pub type LSBF_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, LSBF_A, 3>;
impl<'a> LSBF_W<'a> {
...
pub type CPHA_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, CPHA_A, 4>;
impl<'a> CPHA_W<'a> {
...
pub type CPOL_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, CPOL_A, 5>;
impl<'a> CPOL_W<'a> {
...
pub type LOOP_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, LOOP_A, 7>;
impl<'a> LOOP_W<'a> {
    #[doc = "Disabled."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type SPOL0_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, SPOL0_A, 8>;
impl<'a> SPOL0_W<'a> {
...
pub type SPOL1_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, SPOL1_A, 9>;
impl<'a> SPOL1_W<'a> {
...
pub type SPOL2_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, SPOL2_A, 10>;
impl<'a> SPOL2_W<'a> {
...
pub type SPOL3_W<'a> = crate::BitWriter<'a, u32, CFG_SPEC, SPOL3_A, 11>;
impl<'a> SPOL3_W<'a> {
