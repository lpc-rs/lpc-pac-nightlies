...
pub type IMPLEMENTATIONREVISION_R = crate::FieldReader<u8, u8>;
...
pub type MINORETMARCHITECTUREVERSION_R = crate::FieldReader<u8, u8>;
...
pub type MAJORETMARCHITECTUREVERSION_R = crate::FieldReader<u8, u8>;
...
pub type THUMBINSTRUCTIONTRACING_R = crate::BitReader<THUMBINSTRUCTIONTRACING_A>;
...
pub type SECURITYEXTENSIONSUPPORT_R = crate::BitReader<SECURITYEXTENSIONSUPPORT_A>;
...
pub type BRANCHPACKETENCODING_R = crate::BitReader<BRANCHPACKETENCODING_A>;
...
pub type IMPLEMENTORCODE_R = crate::FieldReader<u8, u8>;
impl R {
    ...
    pub fn load_pcfirst(&self) -> LOADPCFIRST_R {
        LOADPCFIRST_R::new(((self.bits >> 16) & 1) != 0)
    }
    ...
    pub fn thumb_instruction_tracing(&self) -> THUMBINSTRUCTIONTRACING_R {
        THUMBINSTRUCTIONTRACING_R::new(((self.bits >> 18) & 1) != 0)
    }
    ...
    pub fn security_extension_support(&self) -> SECURITYEXTENSIONSUPPORT_R {
        SECURITYEXTENSIONSUPPORT_R::new(((self.bits >> 19) & 1) != 0)
    }
    ...
    pub fn branch_packet_encoding(&self) -> BRANCHPACKETENCODING_R {
        BRANCHPACKETENCODING_R::new(((self.bits >> 20) & 1) != 0)
    }
