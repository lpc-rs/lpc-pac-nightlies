...
pub type ETMPD_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, bool, 0>;
...
pub type PS_W<'a> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 3, 4>;
...
pub type SP_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, bool, 7>;
...
pub type BO_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, bool, 8>;
...
pub type DRC_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, bool, 9>;
...
pub type ETMP_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, bool, 10>;
...
pub type ETMPS_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, ETMPS_A, 11>;
impl<'a> ETMPS_W<'a> {
    #[doc = "ETMEN is LOW."]
    #[inline(always)]
...
pub type PM2_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, bool, 13>;
...
pub type PM_W<'a> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 2, 16>;
...
pub type PS3_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, bool, 21>;
...
pub type TE_W<'a> = crate::BitWriter<'a, u32, CR_SPEC, bool, 28>;
impl R {
