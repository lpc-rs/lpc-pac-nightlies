...
pub type EM0_W<'a> = crate::BitWriter<'a, u32, EMR_SPEC, bool, 0>;
...
pub type EM1_W<'a> = crate::BitWriter<'a, u32, EMR_SPEC, bool, 1>;
...
pub type EM2_W<'a> = crate::BitWriter<'a, u32, EMR_SPEC, bool, 2>;
...
pub type EM3_W<'a> = crate::BitWriter<'a, u32, EMR_SPEC, bool, 3>;
...
pub type EMC0_W<'a> = crate::FieldWriterSafe<'a, u32, EMR_SPEC, u8, EMC0_A, 2, 4>;
impl<'a> EMC0_W<'a> {
    #[doc = "Do Nothing."]
    #[inline(always)]
...
pub type EMC1_W<'a> = crate::FieldWriterSafe<'a, u32, EMR_SPEC, u8, EMC1_A, 2, 6>;
impl<'a> EMC1_W<'a> {
    #[doc = "Do Nothing."]
    #[inline(always)]
    pub fn do_nothing(self) -> &'a mut W {
...
pub type EMC2_W<'a> = crate::FieldWriterSafe<'a, u32, EMR_SPEC, u8, EMC2_A, 2, 8>;
impl<'a> EMC2_W<'a> {
    #[doc = "Do Nothing."]
    #[inline(always)]
    pub fn do_nothing(self) -> &'a mut W {
...
pub type EMC3_W<'a> = crate::FieldWriterSafe<'a, u32, EMR_SPEC, u8, EMC3_A, 2, 10>;
impl<'a> EMC3_W<'a> {
    #[doc = "Do Nothing."]
    #[inline(always)]
    pub fn do_nothing(self) -> &'a mut W {
