...
pub type TIMEOUT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL_SPEC, u16, u16, 16, O>;
...
pub type CSHIGH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CTRL_SPEC, u8, u8, 4, O>;
...
pub type D_PRFTCH_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, O>;
...
pub type MODE3_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, MODE3_A, O>;
...
pub type PRFTCH_DIS_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, PRFTCH_DIS_A, O>;
impl<'a, const O: u8> PRFTCH_DIS_W<'a, O> {
...
pub type DUAL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, DUAL_A, O>;
...
pub type RFCLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, RFCLK_A, O>;
impl<'a, const O: u8> RFCLK_W<'a, O> {
...
pub type FBCLK_W<'a, const O: u8> = crate::BitWriter<'a, u32, CTRL_SPEC, FBCLK_A, O>;
impl<'a, const O: u8> FBCLK_W<'a, O> {
...
impl W {
    ...
    #[doc = "Bits 16:19 - This field controls the minimum CS high time, expressed as a number of serial clock periods minus one."]
    #[inline(always)]
    pub fn cshigh(&mut self) -> CSHIGH_W<16> {
        CSHIGH_W::new(self)
    }
    #[doc = "Bit 21 - This bit allows conditioning of memory mode prefetches based on the AHB HPROT (instruction/data) access information. A 1 in this register means that the SPIFI will not attempt a speculative prefetch when it encounters data accesses."]
    #[inline(always)]
    pub fn d_prftch_dis(&mut self) -> D_PRFTCH_DIS_W<21> {
        D_PRFTCH_DIS_W::new(self)
    }
    #[doc = "Bit 22 - If this bit is 1 when a command ends, the SPIFI will assert its interrupt request output. See INTRQ in the status register for further details."]
    #[inline(always)]
    pub fn inten(&mut self) -> INTEN_W<22> {
        INTEN_W::new(self)
    }
    #[doc = "Bit 23 - SPI Mode 3 select."]
    #[inline(always)]
    pub fn mode3(&mut self) -> MODE3_W<23> {
        MODE3_W::new(self)
    }
    #[doc = "Bit 27 - Cache prefetching enable. The SPIFI includes an internal cache. A 1 in this bit disables prefetching of cache lines."]
    #[inline(always)]
    pub fn prftch_dis(&mut self) -> PRFTCH_DIS_W<27> {
        PRFTCH_DIS_W::new(self)
    }
    #[doc = "Bit 28 - Select dual protocol."]
    #[inline(always)]
    pub fn dual(&mut self) -> DUAL_W<28> {
        DUAL_W::new(self)
    }
    #[doc = "Bit 29 - Select active clock edge for input data."]
    #[inline(always)]
    pub fn rfclk(&mut self) -> RFCLK_W<29> {
        RFCLK_W::new(self)
    }
    #[doc = "Bit 30 - Feedback clock select."]
    #[inline(always)]
    pub fn fbclk(&mut self) -> FBCLK_W<30> {
        FBCLK_W::new(self)
    }
    #[doc = "Bit 31 - A 1 in this bit enables the DMA Request output from the SPIFI. Set this bit only when a DMA channel is used to transfer data in peripheral mode. Do not set this bit when a DMA channel is used for memory-to-memory transfers from the SPIFI memory area. DMAEN should only be used in Command mode."]
    #[inline(always)]
    pub fn dmaen(&mut self) -> DMAEN_W<31> {
        DMAEN_W::new(self)
    }
