...
pub type TXLVLENA_W<'a> = crate::BitWriter<'a, u32, FIFOTRIG_SPEC, TXLVLENA_A, 0>;
impl<'a> TXLVLENA_W<'a> {
...
pub type RXLVLENA_W<'a> = crate::BitWriter<'a, u32, FIFOTRIG_SPEC, RXLVLENA_A, 1>;
impl<'a> RXLVLENA_W<'a> {
...
pub type TXLVL_W<'a> = crate::FieldWriter<'a, u32, FIFOTRIG_SPEC, u8, u8, 4, 8>;
...
pub type RXLVL_W<'a> = crate::FieldWriter<'a, u32, FIFOTRIG_SPEC, u8, u8, 4, 16>;
impl R {
