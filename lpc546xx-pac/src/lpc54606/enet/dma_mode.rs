...
pub type SWR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_MODE_SPEC, bool, O>;
...
pub type DA_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_MODE_SPEC, bool, O>;
...
pub type TAA_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_MODE_SPEC, u8, u8, 3, O>;
...
pub type TXPR_W<'a, const O: u8> = crate::BitWriter<'a, u32, DMA_MODE_SPEC, bool, O>;
...
pub type PR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, DMA_MODE_SPEC, u8, u8, 3, O>;
impl R {
