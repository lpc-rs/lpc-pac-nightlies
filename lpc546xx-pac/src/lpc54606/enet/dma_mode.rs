...
pub type SWR_W<'a> = crate::BitWriter<'a, u32, DMA_MODE_SPEC, bool, 0>;
...
pub type DA_W<'a> = crate::BitWriter<'a, u32, DMA_MODE_SPEC, bool, 1>;
...
pub type TAA_W<'a> = crate::FieldWriter<'a, u32, DMA_MODE_SPEC, u8, u8, 3, 2>;
...
pub type TXPR_W<'a> = crate::BitWriter<'a, u32, DMA_MODE_SPEC, bool, 11>;
...
pub type PR_W<'a> = crate::FieldWriter<'a, u32, DMA_MODE_SPEC, u8, u8, 3, 12>;
impl R {
