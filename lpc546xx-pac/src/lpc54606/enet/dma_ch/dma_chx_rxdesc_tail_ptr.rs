...
pub type RDTP_R = crate::FieldReader<u32, u32>;
#[doc = "Field `RDTP` writer - Receive Tail Pointer This field contains the tail pointer for the Rx ring."]
pub type RDTP_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, DMA_CHX_RXDESC_TAIL_PTR_SPEC, u32, u32, 30, O>;
impl R {
