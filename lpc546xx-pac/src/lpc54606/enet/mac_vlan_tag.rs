...
pub type VL_W<'a> = crate::FieldWriter<'a, u32, MAC_VLAN_TAG_SPEC, u16, u16, 16, 0>;
...
pub type ETV_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 16>;
...
pub type VTIM_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 17>;
#[doc = "Field `ESVL` reader - Enable S-VLAN."]
pub type ESVL_R = crate::BitReader<bool>;
#[doc = "Field `ESVL` writer - Enable S-VLAN."]
pub type ESVL_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 18>;
...
pub type ERSVLM_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 19>;
...
pub type DOVLTC_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 20>;
...
pub type EVLS_W<'a> = crate::FieldWriter<'a, u32, MAC_VLAN_TAG_SPEC, u8, u8, 2, 21>;
...
pub type EVLRXS_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 24>;
...
pub type VTHM_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 25>;
...
pub type EDVLP_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 26>;
...
pub type ERIVLT_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 27>;
...
pub type EIVLS_W<'a> = crate::FieldWriter<'a, u32, MAC_VLAN_TAG_SPEC, u8, u8, 2, 28>;
...
pub type EIVLRXS_W<'a> = crate::BitWriter<'a, u32, MAC_VLAN_TAG_SPEC, bool, 31>;
impl R {
