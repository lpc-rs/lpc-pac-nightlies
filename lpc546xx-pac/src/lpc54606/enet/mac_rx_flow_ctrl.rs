...
pub type RFE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_RX_FLOW_CTRL_SPEC, bool, O>;
...
pub type UP_W<'a, const O: u8> = crate::BitWriter<'a, u32, MAC_RX_FLOW_CTRL_SPEC, bool, O>;
impl R {
