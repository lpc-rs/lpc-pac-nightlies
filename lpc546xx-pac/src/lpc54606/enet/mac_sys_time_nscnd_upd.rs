...
pub type TSSS_W<'a> = crate::FieldWriter<'a, u32, MAC_SYS_TIME_NSCND_UPD_SPEC, u32, u32, 31, 0>;
...
pub type ADDSUB_W<'a> = crate::BitWriter<'a, u32, MAC_SYS_TIME_NSCND_UPD_SPEC, bool, 31>;
impl R {
