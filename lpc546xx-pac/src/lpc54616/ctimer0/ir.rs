...
pub type CR2INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IR_SPEC, bool, O>;
...
pub type CR3INT_W<'a, const O: u8> = crate::BitWriter<'a, u32, IR_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[doc = "Bit 5 - Interrupt flag for capture channel 1 event."]
    #[inline(always)]
    pub fn cr1int(&mut self) -> CR1INT_W<5> {
        CR1INT_W::new(self)
    }
    #[doc = "Bit 6 - Interrupt flag for capture channel 2 event."]
    #[inline(always)]
    pub fn cr2int(&mut self) -> CR2INT_W<6> {
        CR2INT_W::new(self)
    }
    #[doc = "Bit 7 - Interrupt flag for capture channel 3 event."]
    #[inline(always)]
    pub fn cr3int(&mut self) -> CR3INT_W<7> {
        CR3INT_W::new(self)
    }
