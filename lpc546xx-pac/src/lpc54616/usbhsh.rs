...
#[doc = "ATL_PTD_BASE_ADDR (rw) register accessor: an alias for `Reg<ATL_PTD_BASE_ADDR_SPEC>`"]
...
#[doc = "ISO_PTD_BASE_ADDR (rw) register accessor: an alias for `Reg<ISO_PTD_BASE_ADDR_SPEC>`"]
...
#[doc = "INT_PTD_BASE_ADDR (rw) register accessor: an alias for `Reg<INT_PTD_BASE_ADDR_SPEC>`"]
...
#[doc = "DATA_PAYLOAD_BASE_ADDR (rw) register accessor: an alias for `Reg<DATA_PAYLOAD_BASE_ADDR_SPEC>`"]
...
pub mod portsc1;
#[doc = "ATL_PTD_DONE_MAP (rw) register accessor: an alias for `Reg<ATL_PTD_DONE_MAP_SPEC>`"]
...
#[doc = "ATL_PTD_SKIP_MAP (rw) register accessor: an alias for `Reg<ATL_PTD_SKIP_MAP_SPEC>`"]
...
#[doc = "ISO_PTD_DONE_MAP (rw) register accessor: an alias for `Reg<ISO_PTD_DONE_MAP_SPEC>`"]
...
#[doc = "ISO_PTD_SKIP_MAP (rw) register accessor: an alias for `Reg<ISO_PTD_SKIP_MAP_SPEC>`"]
...
#[doc = "INT_PTD_DONE_MAP (rw) register accessor: an alias for `Reg<INT_PTD_DONE_MAP_SPEC>`"]
...
#[doc = "INT_PTD_SKIP_MAP (rw) register accessor: an alias for `Reg<INT_PTD_SKIP_MAP_SPEC>`"]
...
#[doc = "LAST_PTD_INUSE (rw) register accessor: an alias for `Reg<LAST_PTD_INUSE_SPEC>`"]
...
#[doc = "UTMIPLUS_ULPI_DEBUG (rw) register accessor: an alias for `Reg<UTMIPLUS_ULPI_DEBUG_SPEC>`"]
