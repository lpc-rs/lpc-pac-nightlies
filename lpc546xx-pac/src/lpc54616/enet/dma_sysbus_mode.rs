...
pub type FB_W<'a> = crate::BitWriter<'a, u32, DMA_SYSBUS_MODE_SPEC, bool, 0>;
...
pub type AAL_W<'a> = crate::BitWriter<'a, u32, DMA_SYSBUS_MODE_SPEC, bool, 12>;
...
pub type MB_W<'a> = crate::BitWriter<'a, u32, DMA_SYSBUS_MODE_SPEC, bool, 14>;
...
pub type RB_W<'a> = crate::BitWriter<'a, u32, DMA_SYSBUS_MODE_SPEC, bool, 15>;
impl R {
