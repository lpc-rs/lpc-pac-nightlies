...
pub type TWT_W<'a> = crate::FieldWriter<'a, u32, MAC_LPI_TIMER_CTRL_SPEC, u16, u16, 16, 0>;
...
pub type LST_W<'a> = crate::FieldWriter<'a, u32, MAC_LPI_TIMER_CTRL_SPEC, u16, u16, 10, 16>;
impl R {
