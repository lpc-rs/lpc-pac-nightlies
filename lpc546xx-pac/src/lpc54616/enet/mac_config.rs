...
pub type RE_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 0>;
...
pub type TE_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 1>;
...
pub type PRELEN_W<'a> = crate::FieldWriter<'a, u32, MAC_CONFIG_SPEC, u8, u8, 2, 2>;
...
pub type DC_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 4>;
...
pub type BL_W<'a> = crate::FieldWriter<'a, u32, MAC_CONFIG_SPEC, u8, u8, 2, 5>;
...
pub type DR_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 8>;
...
pub type DCRS_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 9>;
...
pub type DO_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 10>;
...
pub type ECRSFD_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 11>;
...
pub type LM_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 12>;
...
pub type DM_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 13>;
...
pub type FES_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 14>;
...
pub type JE_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 16>;
...
pub type JD_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 17>;
...
pub type BE_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 18>;
...
pub type WD_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 19>;
...
pub type ACS_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 20>;
...
pub type CST_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 21>;
#[doc = "Field `S2KP` reader - IEEE 802."]
pub type S2KP_R = crate::BitReader<bool>;
#[doc = "Field `S2KP` writer - IEEE 802."]
pub type S2KP_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 22>;
...
pub type GPSLCE_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 23>;
...
pub type IPG_W<'a> = crate::FieldWriter<'a, u32, MAC_CONFIG_SPEC, u8, u8, 3, 24>;
...
pub type IPC_W<'a> = crate::BitWriter<'a, u32, MAC_CONFIG_SPEC, bool, 27>;
impl R {
