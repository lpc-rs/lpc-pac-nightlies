...
pub type VECTRESET_W<'a> = crate::BitWriter<'a, u32, AIRCR_SPEC, bool, 0>;
#[doc = "Field `VECTCLRACTIVE` writer - no description available"]
pub type VECTCLRACTIVE_W<'a> = crate::BitWriter<'a, u32, AIRCR_SPEC, bool, 1>;
...
pub type SYSRESETREQ_W<'a> = crate::BitWriter<'a, u32, AIRCR_SPEC, SYSRESETREQ_AW, 2>;
...
pub type PRIGROUP_W<'a> = crate::FieldWriter<'a, u32, AIRCR_SPEC, u8, u8, 3, 8>;
#[doc = "no description available\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub type VECTKEY_W<'a> = crate::FieldWriter<'a, u32, AIRCR_SPEC, u16, u16, 16, 16>;
impl R {
