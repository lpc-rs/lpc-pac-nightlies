...
pub type HALTED_W<'a> = crate::BitWriter<'a, u32, DFSR_SPEC, HALTED_A, 0>;
impl<'a> HALTED_W<'a> {
...
pub type BKPT_W<'a> = crate::BitWriter<'a, u32, DFSR_SPEC, BKPT_A, 1>;
impl<'a> BKPT_W<'a> {
...
pub type DWTTRAP_W<'a> = crate::BitWriter<'a, u32, DFSR_SPEC, DWTTRAP_A, 2>;
impl<'a> DWTTRAP_W<'a> {
...
pub type VCATCH_W<'a> = crate::BitWriter<'a, u32, DFSR_SPEC, VCATCH_A, 3>;
impl<'a> VCATCH_W<'a> {
...
pub type EXTERNAL_W<'a> = crate::BitWriter<'a, u32, DFSR_SPEC, EXTERNAL_A, 4>;
impl<'a> EXTERNAL_W<'a> {
