...
pub type ENABLE_W<'a> = crate::BitWriter<'a, u32, FIFO_CTRL_SPEC, ENABLE_A, 0>;
impl<'a> ENABLE_W<'a> {
...
pub type RESETN_W<'a> = crate::BitWriter<'a, u32, FIFO_CTRL_SPEC, RESETN_A, 1>;
impl<'a> RESETN_W<'a> {
    #[doc = "Reset the FIFO."]
    #[inline(always)]
...
pub type INTEN_W<'a> = crate::BitWriter<'a, u32, FIFO_CTRL_SPEC, INTEN_A, 2>;
impl<'a> INTEN_W<'a> {
...
pub type DMAEN_W<'a> = crate::BitWriter<'a, u32, FIFO_CTRL_SPEC, DMAEN_A, 3>;
impl<'a> DMAEN_W<'a> {
...
pub type TRIGLVL_W<'a> = crate::FieldWriter<'a, u32, FIFO_CTRL_SPEC, u8, u8, 5, 16>;
impl R {
