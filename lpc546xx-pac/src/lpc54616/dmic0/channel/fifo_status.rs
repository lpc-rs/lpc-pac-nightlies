...
pub type INT_W<'a> = crate::BitWriter<'a, u32, FIFO_STATUS_SPEC, bool, 0>;
...
pub type OVERRUN_W<'a> = crate::BitWriter<'a, u32, FIFO_STATUS_SPEC, bool, 1>;
...
pub type UNDERRUN_W<'a> = crate::BitWriter<'a, u32, FIFO_STATUS_SPEC, bool, 2>;
impl R {
