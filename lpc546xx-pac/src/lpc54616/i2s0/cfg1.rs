...
pub type MAINENABLE_W<'a> = crate::BitWriter<'a, u32, CFG1_SPEC, MAINENABLE_A, 0>;
...
pub type DATAPAUSE_W<'a> = crate::BitWriter<'a, u32, CFG1_SPEC, DATAPAUSE_A, 1>;
...
pub type PAIRCOUNT_W<'a> = crate::FieldWriterSafe<'a, u32, CFG1_SPEC, u8, PAIRCOUNT_A, 2, 2>;
...
pub type MSTSLVCFG_W<'a> = crate::FieldWriterSafe<'a, u32, CFG1_SPEC, u8, MSTSLVCFG_A, 2, 4>;
...
pub type MODE_W<'a> = crate::FieldWriterSafe<'a, u32, CFG1_SPEC, u8, MODE_A, 2, 6>;
impl<'a> MODE_W<'a> {
...
pub type RIGHTLOW_W<'a> = crate::BitWriter<'a, u32, CFG1_SPEC, RIGHTLOW_A, 8>;
impl<'a> RIGHTLOW_W<'a> {
...
pub type LEFTJUST_W<'a> = crate::BitWriter<'a, u32, CFG1_SPEC, LEFTJUST_A, 9>;
impl<'a> LEFTJUST_W<'a> {
...
pub type ONECHANNEL_W<'a> = crate::BitWriter<'a, u32, CFG1_SPEC, ONECHANNEL_A, 10>;
...
pub type PDMDATA_W<'a> = crate::BitWriter<'a, u32, CFG1_SPEC, PDMDATA_A, 11>;
impl<'a> PDMDATA_W<'a> {
...
pub type SCK_POL_W<'a> = crate::BitWriter<'a, u32, CFG1_SPEC, SCK_POL_A, 12>;
impl<'a> SCK_POL_W<'a> {
...
pub type WS_POL_W<'a> = crate::BitWriter<'a, u32, CFG1_SPEC, WS_POL_A, 13>;
impl<'a> WS_POL_W<'a> {
...
pub type DATALEN_W<'a> = crate::FieldWriter<'a, u32, CFG1_SPEC, u8, u8, 5, 16>;
impl R {
