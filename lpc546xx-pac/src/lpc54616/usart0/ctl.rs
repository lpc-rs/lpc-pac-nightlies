...
pub type TXBRKEN_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, TXBRKEN_A, 1>;
impl<'a> TXBRKEN_W<'a> {
...
pub type ADDRDET_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, ADDRDET_A, 2>;
impl<'a> ADDRDET_W<'a> {
...
pub type TXDIS_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, TXDIS_A, 6>;
impl<'a> TXDIS_W<'a> {
...
pub type CC_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, CC_A, 8>;
impl<'a> CC_W<'a> {
...
pub type CLRCCONRX_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, CLRCCONRX_A, 9>;
...
pub type AUTOBAUD_W<'a> = crate::BitWriter<'a, u32, CTL_SPEC, AUTOBAUD_A, 16>;
impl<'a> AUTOBAUD_W<'a> {
