...
pub type TRIM_W<'a> = crate::FieldWriter<'a, u32, FROCTRL_SPEC, u16, u16, 14, 0>;
...
pub type SEL_W<'a> = crate::BitWriter<'a, u32, FROCTRL_SPEC, bool, 14>;
...
pub type FREQTRIM_W<'a> = crate::FieldWriter<'a, u32, FROCTRL_SPEC, u8, u8, 8, 16>;
...
pub type USBCLKADJ_W<'a> = crate::BitWriter<'a, u32, FROCTRL_SPEC, bool, 24>;
...
pub type USBMODCHG_W<'a> = crate::BitWriter<'a, u32, FROCTRL_SPEC, bool, 25>;
...
pub type HSPDCLK_W<'a> = crate::BitWriter<'a, u32, FROCTRL_SPEC, bool, 30>;
#[doc = "Field `WRTRIM` reader - Write Trim value."]
pub type WRTRIM_R = crate::BitReader<bool>;
#[doc = "Field `WRTRIM` writer - Write Trim value."]
pub type WRTRIM_W<'a> = crate::BitWriter<'a, u32, FROCTRL_SPEC, bool, 31>;
impl R {
