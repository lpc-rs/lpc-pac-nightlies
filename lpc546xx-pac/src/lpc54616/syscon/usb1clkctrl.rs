...
pub type AP_FS_DEV_CLK_W<'a> = crate::BitWriter<'a, u32, USB1CLKCTRL_SPEC, bool, 0>;
...
pub type POL_FS_DEV_CLK_W<'a> = crate::BitWriter<'a, u32, USB1CLKCTRL_SPEC, bool, 1>;
...
pub type AP_FS_HOST_CLK_W<'a> = crate::BitWriter<'a, u32, USB1CLKCTRL_SPEC, bool, 2>;
...
pub type POL_FS_HOST_CLK_W<'a> = crate::BitWriter<'a, u32, USB1CLKCTRL_SPEC, bool, 3>;
...
pub type HS_DEV_WAKEUP_N_W<'a> = crate::BitWriter<'a, u32, USB1CLKCTRL_SPEC, bool, 4>;
impl R {
