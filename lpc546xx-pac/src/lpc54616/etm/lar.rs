...
pub type WRITEACCESSCODE_R = crate::FieldReader<u32, u32>;
...
pub type WRITEACCESSCODE_W<'a> = crate::FieldWriter<'a, u32, LAR_SPEC, u32, u32, 32, 0>;
impl R {
