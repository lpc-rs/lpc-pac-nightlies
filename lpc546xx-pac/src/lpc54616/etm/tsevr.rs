...
pub type TIMESTAMPEVENT_R = crate::FieldReader<u16, u16>;
#[doc = "Field `TimestampEvent` writer - Timestamp event."]
pub type TIMESTAMPEVENT_W<'a> = crate::FieldWriter<'a, u32, TSEVR_SPEC, u16, u16, 12, 0>;
impl R {
