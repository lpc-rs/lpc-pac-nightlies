...
pub type TRACECONTROLENABLE_R = crate::BitReader<TRACECONTROLENABLE_A>;
...
pub type TRACECONTROLENABLE_W<'a> = crate::BitWriter<'a, u32, TECR1_SPEC, TRACECONTROLENABLE_A, 25>;
...
impl R {
    ...
    pub fn trace_control_enable(&self) -> TRACECONTROLENABLE_R {
        TRACECONTROLENABLE_R::new(((self.bits >> 25) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 25 - Trace start/stop enable. The trace start/stop resource, resource 0x5F, is unaffected by the value of this bit."]
