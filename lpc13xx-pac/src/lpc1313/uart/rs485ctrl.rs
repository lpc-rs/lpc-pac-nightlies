...
#[doc = "Field `SEL` reader - Direction control pins select"]
pub type SEL_R = crate::BitReader<SEL_A>;
#[doc = "Direction control pins select\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum SEL_A {
...
#[doc = "Field `SEL` writer - Direction control pins select"]
...
#[doc = "Field `OINV` reader - This bit reverses the polarity of the direction control signal on the RTS (or DTR) pin."]
pub type OINV_R = crate::BitReader<OINV_A>;
#[doc = "This bit reverses the polarity of the direction control signal on the RTS (or DTR) pin.\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum OINV_A {
...
#[doc = "Field `OINV` writer - This bit reverses the polarity of the direction control signal on the RTS (or DTR) pin."]
