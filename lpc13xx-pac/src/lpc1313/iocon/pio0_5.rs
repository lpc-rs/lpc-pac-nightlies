...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_5_SPEC, u8, FUNC_A, 3, O>;
...
impl I2CMODE_R {
    ...
    pub fn variant(&self) -> I2CMODE_A {
        match self.bits {
            0 => I2CMODE_A::STANDARDFAST,
            1 => I2CMODE_A::STANDARDIO,
            2 => I2CMODE_A::FAST_MODE_PLUS_I2C,
            _ => unreachable!(),
        }
    }
    #[doc = "Checks if the value of the field is `STANDARDFAST`"]
    #[inline(always)]
    pub fn is_standardfast(&self) -> bool {
        *self == I2CMODE_A::STANDARDFAST
    }
...
pub type I2CMODE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_5_SPEC, u8, I2CMODE_A, 2, O>;
impl<'a, const O: u8> I2CMODE_W<'a, O> {
    #[doc = "Standard mode/ Fast-mode I2C"]
    #[inline(always)]
    pub fn standardfast(self) -> &'a mut W {
        self.variant(I2CMODE_A::STANDARDFAST)
    }
