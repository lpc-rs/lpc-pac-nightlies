...
pub struct R(crate::R<PIO2_0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO2_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO2_0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO2_0_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO2_0` writer"]
pub struct W(crate::W<PIO2_0_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO2_0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIO2_0_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO2_0_SPEC>) -> Self {
        W(writer)
    }
}
...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: Select function PIO2_0."]
    PIO2 = 0,
    #[doc = "1: Select function DTR."]
    DTR_ = 1,
    #[doc = "2: Select function SSEL1 (function not available on all parts)."]
    SSEL = 2,
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO2_0_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO2_0_SPEC, HYS_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO2_0_SPEC, OD_A, O>;
