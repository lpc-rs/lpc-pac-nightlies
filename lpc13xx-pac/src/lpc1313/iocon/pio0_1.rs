...
pub enum FUNC_A {
    ...
    CT3 = 2,
    #[doc = "3: Selects function USB_FTOGGLE (function not available on all parts)"]
    USB = 3,
}
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_1_SPEC, u8, FUNC_A, 3, O>;
