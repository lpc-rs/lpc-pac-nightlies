...
pub enum FUNC_A {
    ...
    PIO = 0,
    #[doc = "1: Selects function USB_CONNECT (function not available on all parts)."]
    USB = 1,
    #[doc = "2: Selects function SCK0 (only if pin PIO0_6/ USB_CONNECT/ SCK0 selected in Table 139)."]
    SCK = 2,
}
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_6_SPEC, u8, FUNC_A, 3, O>;
