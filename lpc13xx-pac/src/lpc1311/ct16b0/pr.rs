...
#[doc = "Field `PRVAL` reader - Prescale max value."]
pub type PRVAL_R = crate::FieldReader<u16, u16>;
#[doc = "Field `PRVAL` writer - Prescale max value."]
pub type PRVAL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PR_SPEC, u16, u16, 16, O>;
impl R {
    #[doc = "Bits 0:15 - Prescale max value."]
    #[inline(always)]
    pub fn prval(&self) -> PRVAL_R {
        PRVAL_R::new((self.bits & 0xffff) as u16)
    }
}
impl W {
    #[doc = "Bits 0:15 - Prescale max value."]
    #[inline(always)]
    pub fn prval(&mut self) -> PRVAL_W<0> {
        PRVAL_W::new(self)
    }
