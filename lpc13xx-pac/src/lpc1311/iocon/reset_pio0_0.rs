...
#[repr(u8)]
pub enum FUNC_A {
    #[doc = "0: Selects function RESET."]
    RES = 0,
    #[doc = "1: Selects function PIO0_0."]
    PIO = 1,
}
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RESET_PIO0_0_SPEC, u8, FUNC_A, 3, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "Selects function RESET."]
    #[inline(always)]
    pub fn res(self) -> &'a mut W {
        self.variant(FUNC_A::RES)
    }
...
pub type MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, RESET_PIO0_0_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESET_PIO0_0_SPEC, HYS_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, RESET_PIO0_0_SPEC, OD_A, O>;
...
#[doc = "`reset()` method sets RESET_PIO0_0 to value 0xd0"]
