#[doc = "Register `PIO3_1` reader"]
pub struct R(crate::R<PIO3_1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO3_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO3_1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO3_1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO3_1` writer"]
pub struct W(crate::W<PIO3_1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO3_1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIO3_1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO3_1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO3_1_SPEC, u8, FUNC_A, 3, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO3_1_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO3_1_SPEC, HYS_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO3_1_SPEC, OD_A, O>;
...
#[doc = "I/O configuration for pin PIO3_1/DSR\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio3_1](index.html) module"]
pub struct PIO3_1_SPEC;
impl crate::RegisterSpec for PIO3_1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio3_1::R](R) reader structure"]
impl crate::Readable for PIO3_1_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio3_1::W](W) writer structure"]
impl crate::Writable for PIO3_1_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO3_1 to value 0xd0"]
impl crate::Resettable for PIO3_1_SPEC {
    #[inline(always)]
