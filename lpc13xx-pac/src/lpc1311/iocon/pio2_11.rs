...
pub struct R(crate::R<PIO2_11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO2_11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO2_11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO2_11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO2_11` writer"]
pub struct W(crate::W<PIO2_11_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO2_11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIO2_11_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO2_11_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum FUNC_A {
    ...
    PIO = 0,
    #[doc = "1: Selects function SCK0 (only if pin PIO2_11/SCK0 selected in Table 139)"]
    SCK = 1,
}
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO2_11_SPEC, u8, FUNC_A, 3, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO2_11_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO2_11_SPEC, HYS_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO2_11_SPEC, OD_A, O>;
...
pub struct PIO2_11_SPEC;
impl crate::RegisterSpec for PIO2_11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio2_11::R](R) reader structure"]
impl crate::Readable for PIO2_11_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio2_11::W](W) writer structure"]
impl crate::Writable for PIO2_11_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO2_11 to value 0xd0"]
impl crate::Resettable for PIO2_11_SPEC {
    #[inline(always)]
