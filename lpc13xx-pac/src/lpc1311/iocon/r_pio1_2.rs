#[doc = "Register `R_PIO1_2` reader"]
pub struct R(crate::R<R_PIO1_2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<R_PIO1_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<R_PIO1_2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<R_PIO1_2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `R_PIO1_2` writer"]
pub struct W(crate::W<R_PIO1_2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<R_PIO1_2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<R_PIO1_2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<R_PIO1_2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum FUNC_A {
    ...
    R_ = 0,
    #[doc = "1: Selects function PIO1_2."]
    PIO = 1,
    #[doc = "2: Selects function AD3."]
    AD3 = 2,
    #[doc = "3: Selects function CT32B1_MAT1."]
    CT3 = 3,
}
...
impl FUNC_R {
    ...
    #[doc = "Checks if the value of the field is `R_`"]
    #[inline(always)]
    pub fn is_r_(&self) -> bool {
        *self == FUNC_A::R_
    }
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, R_PIO1_2_SPEC, u8, FUNC_A, 3, O>;
impl<'a, const O: u8> FUNC_W<'a, O> {
    #[doc = "Selects function R. This function is reserved. Select one of the alternate functions below."]
    #[inline(always)]
    pub fn r_(self) -> &'a mut W {
        self.variant(FUNC_A::R_)
    }
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, R_PIO1_2_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, R_PIO1_2_SPEC, HYS_A, O>;
...
pub type ADMODE_W<'a, const O: u8> = crate::BitWriter<'a, u32, R_PIO1_2_SPEC, ADMODE_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, R_PIO1_2_SPEC, OD_A, O>;
...
#[doc = "I/O configuration for pin R/PIO1_2/AD3/ CT32B1_MAT1\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [r_pio1_2](index.html) module"]
pub struct R_PIO1_2_SPEC;
impl crate::RegisterSpec for R_PIO1_2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [r_pio1_2::R](R) reader structure"]
impl crate::Readable for R_PIO1_2_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [r_pio1_2::W](W) writer structure"]
impl crate::Writable for R_PIO1_2_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets R_PIO1_2 to value 0xd0"]
impl crate::Resettable for R_PIO1_2_SPEC {
    #[inline(always)]
