...
#[doc = "Field `SYSOSC_PD` reader - System oscillator power-down\\[1\\]"]
pub type SYSOSC_PD_R = crate::BitReader<SYSOSC_PD_A>;
#[doc = "System oscillator power-down\\[1\\]\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
#[doc = "Field `SYSOSC_PD` writer - System oscillator power-down\\[1\\]"]
...
pub type FIXEDVAL0_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, bool, O>;
#[doc = "Field `USBPAD_PD` reader - USB pad power-down configuration"]
pub type USBPAD_PD_R = crate::BitReader<USBPAD_PD_A>;
#[doc = "USB pad power-down configuration\n\nValue on reset: 1"]
#[derive(Clone, Copy, Debug, PartialEq)]
pub enum USBPAD_PD_A {
    #[doc = "0: USB PHY powered"]
    USB_PHY_POWERED = 0,
    #[doc = "1: USB PHY powered down (suspend mode)"]
...
#[doc = "Field `USBPAD_PD` writer - USB pad power-down configuration"]
...
pub type FIXEDVAL1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, bool, O>;
impl R {
...
#[doc = "`reset()` method sets PDRUNCFG to value 0xfdf0"]
