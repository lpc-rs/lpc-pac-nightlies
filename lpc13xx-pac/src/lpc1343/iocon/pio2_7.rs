#[doc = "Register `PIO2_7` reader"]
pub struct R(crate::R<PIO2_7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO2_7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO2_7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO2_7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO2_7` writer"]
pub struct W(crate::W<PIO2_7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO2_7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIO2_7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO2_7_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO2_7_SPEC, u8, FUNC_A, 3, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO2_7_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO2_7_SPEC, HYS_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO2_7_SPEC, OD_A, O>;
...
#[doc = "I/O configuration for pin PIO2_7\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [pio2_7](index.html) module"]
pub struct PIO2_7_SPEC;
impl crate::RegisterSpec for PIO2_7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [pio2_7::R](R) reader structure"]
impl crate::Readable for PIO2_7_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [pio2_7::W](W) writer structure"]
impl crate::Writable for PIO2_7_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PIO2_7 to value 0xd0"]
impl crate::Resettable for PIO2_7_SPEC {
    #[inline(always)]
