...
pub struct R(crate::R<PIO2_3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PIO2_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PIO2_3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PIO2_3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PIO2_3` writer"]
pub struct W(crate::W<PIO2_3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PIO2_3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PIO2_3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PIO2_3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub enum FUNC_A {
    ...
    RI_ = 1,
    #[doc = "2: Selects function MOSI1 (function not available on all parts)."]
    MOS = 2,
}
...
pub type FUNC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO2_3_SPEC, u8, FUNC_A, 3, O>;
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO2_3_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO2_3_SPEC, HYS_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO2_3_SPEC, OD_A, O>;
