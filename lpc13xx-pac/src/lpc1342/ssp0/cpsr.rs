...
#[doc = "Field `CPSDVSR` reader - This even value between 2 and 254, by which SSP_PCLK is divided to yield the prescaler output clock. Bit 0 always reads as 0."]
pub type CPSDVSR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CPSDVSR` writer - This even value between 2 and 254, by which SSP_PCLK is divided to yield the prescaler output clock. Bit 0 always reads as 0."]
