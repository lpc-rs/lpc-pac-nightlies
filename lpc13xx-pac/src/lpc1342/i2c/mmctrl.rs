...
pub enum MATCH_ALL_A {
    ...
    MATCH = 0,
    #[doc = "1: When this bit is set to 1 and the I 2C is in monitor mode, an interrupt will be generated on ANY address received. This will enable the part to monitor all traffic on the bus."]
    ANYINT = 1,
}
...
impl<'a, const O: u8> MATCH_ALL_W<'a, O> {
    ...
    pub fn anyint(self) -> &'a mut W {
        self.variant(MATCH_ALL_A::ANYINT)
    }
}
impl R {
