...
pub type NCFLAG_R = crate::FieldReader<u8, u8>;
...
pub type NCFLAG_W<'a> = crate::FieldWriter<'a, u32, CONFLAG_SPEC, u8, u8, 4, 0>;
...
pub type BUSERRL_W<'a> = crate::BitWriter<'a, u32, CONFLAG_SPEC, bool, 30>;
...
pub type BUSERRH_W<'a> = crate::BitWriter<'a, u32, CONFLAG_SPEC, bool, 31>;
impl R {
    #[doc = "Bits 0:3 - Bit n is one if a no-change conflict event occurred on output n since reset or a 1 was last written to this bit (output 0 = bit 0, output 1 = bit 1, etc.). The number of bits = number of outputs in this SCT."]
    #[inline(always)]
