...
pub type LADEN_W<'a> = crate::BitWriter<'a, u32, LAD_SPEC, bool, 0>;
...
pub type LADSEL_W<'a> = crate::FieldWriter<'a, u32, LAD_SPEC, u8, u8, 5, 1>;
...
pub type LADREF_W<'a> = crate::BitWriter<'a, u32, LAD_SPEC, LADREF_A, 6>;
impl<'a> LADREF_W<'a> {
    #[doc = "Supply pin VDD"]
    #[inline(always)]
