#![doc = "Peripheral access API for LPC812 microcontrollers (generated using svd2rust v0.25.0 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
impl MTB {
    ...
    pub const PTR: *const mtb::RegisterBlock = 0x1400_0000 as *const _;
