...
pub type PINT0_W<'a> = crate::BitWriter<'a, u32, STARTERP0_SPEC, PINT0_A, 0>;
impl<'a> PINT0_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
...
pub type PINT1_W<'a> = crate::BitWriter<'a, u32, STARTERP0_SPEC, PINT1_A, 1>;
impl<'a> PINT1_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type PINT2_W<'a> = crate::BitWriter<'a, u32, STARTERP0_SPEC, PINT2_A, 2>;
impl<'a> PINT2_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type PINT3_W<'a> = crate::BitWriter<'a, u32, STARTERP0_SPEC, PINT3_A, 3>;
impl<'a> PINT3_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type PINT4_W<'a> = crate::BitWriter<'a, u32, STARTERP0_SPEC, PINT4_A, 4>;
impl<'a> PINT4_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type PINT5_W<'a> = crate::BitWriter<'a, u32, STARTERP0_SPEC, PINT5_A, 5>;
impl<'a> PINT5_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type PINT6_W<'a> = crate::BitWriter<'a, u32, STARTERP0_SPEC, PINT6_A, 6>;
impl<'a> PINT6_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type PINT7_W<'a> = crate::BitWriter<'a, u32, STARTERP0_SPEC, PINT7_A, 7>;
impl<'a> PINT7_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
