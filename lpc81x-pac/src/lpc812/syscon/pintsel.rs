...
#[doc = "Field `INTPIN` reader - Pin number select for pin interrupt or pattern match engine input. (PIO0_0 to PIO0_17 correspond to numbers 0 to 17)."]
pub type INTPIN_R = crate::FieldReader<u8, u8>;
#[doc = "Field `INTPIN` writer - Pin number select for pin interrupt or pattern match engine input. (PIO0_0 to PIO0_17 correspond to numbers 0 to 17)."]
pub type INTPIN_W<'a> = crate::FieldWriter<'a, u32, PINTSEL_SPEC, u8, u8, 6, 0>;
impl R {
