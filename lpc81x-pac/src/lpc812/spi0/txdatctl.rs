...
pub type TXDAT_W<'a> = crate::FieldWriter<'a, u32, TXDATCTL_SPEC, u16, u16, 16, 0>;
...
pub type TXSSEL0_N_W<'a> = crate::BitWriter<'a, u32, TXDATCTL_SPEC, TXSSEL0_N_A, 16>;
...
pub type EOT_W<'a> = crate::BitWriter<'a, u32, TXDATCTL_SPEC, EOT_A, 20>;
impl<'a> EOT_W<'a> {
...
pub type EOF_W<'a> = crate::BitWriter<'a, u32, TXDATCTL_SPEC, EOF_A, 21>;
impl<'a> EOF_W<'a> {
...
pub type RXIGNORE_W<'a> = crate::BitWriter<'a, u32, TXDATCTL_SPEC, RXIGNORE_A, 22>;
impl<'a> RXIGNORE_W<'a> {
...
pub type LEN_W<'a> = crate::FieldWriterSafe<'a, u32, TXDATCTL_SPEC, u8, LEN_A, 4, 24>;
impl<'a> LEN_W<'a> {
