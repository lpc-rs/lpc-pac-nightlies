...
pub type INV_W<'a> = crate::BitWriter<'a, u32, PIO0_10_SPEC, INV_A, 6>;
impl<'a> INV_W<'a> {
...
pub type I2CMODE_W<'a> = crate::FieldWriter<'a, u32, PIO0_10_SPEC, u8, I2CMODE_A, 2, 8>;
impl<'a> I2CMODE_W<'a> {
...
pub type S_MODE_W<'a> = crate::FieldWriterSafe<'a, u32, PIO0_10_SPEC, u8, S_MODE_A, 2, 11>;
impl<'a> S_MODE_W<'a> {
...
pub type CLK_DIV_W<'a> = crate::FieldWriter<'a, u32, PIO0_10_SPEC, u8, CLK_DIV_A, 3, 13>;
impl<'a> CLK_DIV_W<'a> {
    #[doc = "IOCONCLKDIV0"]
    #[inline(always)]
