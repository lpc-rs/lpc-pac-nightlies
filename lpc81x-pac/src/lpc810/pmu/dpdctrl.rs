...
pub type WAKEUPHYS_W<'a> = crate::BitWriter<'a, u32, DPDCTRL_SPEC, WAKEUPHYS_A, 0>;
...
pub type WAKEPAD_DISABLE_W<'a> = crate::BitWriter<'a, u32, DPDCTRL_SPEC, WAKEPAD_DISABLE_A, 1>;
...
pub type LPOSCEN_W<'a> = crate::BitWriter<'a, u32, DPDCTRL_SPEC, LPOSCEN_A, 2>;
impl<'a> LPOSCEN_W<'a> {
    #[doc = "Disabled."]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type LPOSCDPDEN_W<'a> = crate::BitWriter<'a, u32, DPDCTRL_SPEC, LPOSCDPDEN_A, 3>;
...
pub type GPDATA_W<'a> = crate::FieldWriter<'a, u32, DPDCTRL_SPEC, u32, u32, 28, 4>;
impl R {
