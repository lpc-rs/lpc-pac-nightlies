...
pub type PM_W<'a> = crate::FieldWriter<'a, u32, PCON_SPEC, u8, PM_A, 3, 0>;
impl<'a> PM_W<'a> {
...
pub type NODPD_W<'a> = crate::BitWriter<'a, u32, PCON_SPEC, bool, 3>;
#[doc = "Sleep mode flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq)]
...
pub type SLEEPFLAG_W<'a> = crate::BitWriter<'a, u32, PCON_SPEC, SLEEPFLAG_A, 8>;
...
pub type DPDFLAG_W<'a> = crate::BitWriter<'a, u32, PCON_SPEC, DPDFLAG_A, 11>;
impl<'a> DPDFLAG_W<'a> {
