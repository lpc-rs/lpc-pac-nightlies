...
pub type SPI1_MOSI_IO_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN5_SPEC, u8, u8, 8, 0>;
...
pub type SPI1_MISO_IO_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN5_SPEC, u8, u8, 8, 8>;
...
pub type SPI1_SSEL_IO_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN5_SPEC, u8, u8, 8, 16>;
...
pub type CTIN_0_I_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN5_SPEC, u8, u8, 8, 24>;
impl R {
...
impl W {
    ...
    #[doc = "Bits 16:23 - SPI1_SSEL function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_17 (= 0x11)."]
    #[inline(always)]
    pub fn spi1_ssel_io(&mut self) -> SPI1_SSEL_IO_W {
        SPI1_SSEL_IO_W::new(self)
    }
    #[doc = "Bits 24:31 - CTIN_0 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_17 (= 0x11)."]
    #[inline(always)]
    pub fn ctin_0_i(&mut self) -> CTIN_0_I_W {
        CTIN_0_I_W::new(self)
    }
