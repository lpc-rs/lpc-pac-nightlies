...
pub type SPI0_MOSI_IO_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN4_SPEC, u8, u8, 8, 0>;
...
pub type SPI0_MISO_IO_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN4_SPEC, u8, u8, 8, 8>;
...
pub type SPI0_SSEL_IO_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN4_SPEC, u8, u8, 8, 16>;
...
pub type SPI1_SCK_IO_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN4_SPEC, u8, u8, 8, 24>;
impl R {
...
impl W {
    ...
    #[doc = "Bits 16:23 - SPI0_SSEL function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_17 (= 0x11)."]
    #[inline(always)]
    pub fn spi0_ssel_io(&mut self) -> SPI0_SSEL_IO_W {
