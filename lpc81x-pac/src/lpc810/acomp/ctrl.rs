...
pub type EDGESEL_W<'a> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, EDGESEL_A, 2, 3>;
impl<'a> EDGESEL_W<'a> {
    #[doc = "Falling edges"]
    #[inline(always)]
...
pub type COMPSA_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, COMPSA_A, 6>;
impl<'a> COMPSA_W<'a> {
...
pub type COMP_VP_SEL_W<'a> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, COMP_VP_SEL_A, 3, 8>;
...
pub type COMP_VM_SEL_W<'a> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, COMP_VM_SEL_A, 3, 11>;
...
pub type EDGECLR_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 20>;
...
pub type COMPSTAT_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 21>;
...
pub type COMPEDGE_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, bool, 23>;
...
pub type HYS_W<'a> = crate::FieldWriterSafe<'a, u32, CTRL_SPEC, u8, HYS_A, 2, 25>;
impl<'a> HYS_W<'a> {
