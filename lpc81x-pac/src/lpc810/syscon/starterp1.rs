...
pub type SPI0_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, SPI0_A, 0>;
impl<'a> SPI0_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
...
pub type SPI1_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, SPI1_A, 1>;
impl<'a> SPI1_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type USART0_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, USART0_A, 3>;
impl<'a> USART0_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type USART1_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, USART1_A, 4>;
impl<'a> USART1_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type USART2_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, USART2_A, 5>;
impl<'a> USART2_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type I2C0_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, I2C0_A, 8>;
impl<'a> I2C0_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type WWDT_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, WWDT_A, 12>;
impl<'a> WWDT_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type BOD_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, BOD_A, 13>;
impl<'a> BOD_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
...
pub type WKT_W<'a> = crate::BitWriter<'a, u32, STARTERP1_SPEC, WKT_A, 15>;
impl<'a> WKT_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
