...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, PIO0_7_SPEC, u8, MODE_A, 2, O>;
...
pub type HYS_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_7_SPEC, HYS_A, O>;
...
pub type INV_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_7_SPEC, INV_A, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_7_SPEC, OD_A, O>;
...
pub type S_MODE_R = crate::FieldReader<u8, S_MODE_A>;
...
pub type S_MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PIO0_7_SPEC, u8, S_MODE_A, 2, O>;
impl<'a, const O: u8> S_MODE_W<'a, O> {
...
pub type CLK_DIV_R = crate::FieldReader<u8, CLK_DIV_A>;
...
pub type CLK_DIV_W<'a, const O: u8> = crate::FieldWriter<'a, u32, PIO0_7_SPEC, u8, CLK_DIV_A, 3, O>;
impl<'a, const O: u8> CLK_DIV_W<'a, O> {
    #[doc = "IOCONCLKDIV0"]
    #[inline(always)]
...
impl R {
    ...
    pub fn s_mode(&self) -> S_MODE_R {
        S_MODE_R::new(((self.bits >> 11) & 3) as u8)
    }
    ...
    pub fn clk_div(&self) -> CLK_DIV_R {
        CLK_DIV_R::new(((self.bits >> 13) & 7) as u8)
    }
}
impl W {
    #[doc = "Bits 3:4 - Selects function mode (on-chip pull-up/pull-down resistor control)."]
    ...
    #[doc = "Bits 11:12 - Digital filter sample mode."]
    #[inline(always)]
    pub fn s_mode(&mut self) -> S_MODE_W<11> {
        S_MODE_W::new(self)
    }
    #[doc = "Bits 13:15 - Select peripheral clock divider for input filter sampling clock. Value 0x7 is reserved."]
    #[inline(always)]
    pub fn clk_div(&mut self) -> CLK_DIV_W<13> {
        CLK_DIV_W::new(self)
    }
