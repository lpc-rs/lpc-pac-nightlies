...
pub type REGMOD_L_R = crate::FieldReader<u8, u8>;
...
pub type REGMOD_L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, REGMODE_SPEC, u8, u8, 5, O>;
...
pub type REGMOD_H_R = crate::FieldReader<u8, u8>;
...
pub type REGMOD_H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, REGMODE_SPEC, u8, u8, 5, O>;
impl R {
    #[doc = "Bits 0:4 - Each bit controls one match/capture register (register 0 = bit 0, register 1 = bit 1, etc.). The number of bits = number of match/captures in this SCT. 0 = register operates as match register. 1 = register operates as capture register."]
    #[inline(always)]
    pub fn regmod_l(&self) -> REGMOD_L_R {
        REGMOD_L_R::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bits 16:20 - Each bit controls one match/capture register (register 0 = bit 16, register 1 = bit 17, etc.). The number of bits = number of match/captures in this SCT. 0 = register operates as match registers. 1 = register operates as capture registers."]
    #[inline(always)]
