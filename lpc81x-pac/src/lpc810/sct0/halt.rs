...
pub type HALTMSK_L_R = crate::FieldReader<u8, u8>;
...
pub type HALTMSK_L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HALT_SPEC, u8, u8, 6, O>;
...
pub type HALTMSK_H_R = crate::FieldReader<u8, u8>;
...
pub type HALTMSK_H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, HALT_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5 - If bit n is one, event n sets the HALT_L bit in the CTRL register (event 0 = bit 0, event 1 = bit 1, etc.). The number of bits = number of events in this SCT."]
    #[inline(always)]
    pub fn haltmsk_l(&self) -> HALTMSK_L_R {
        HALTMSK_L_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - If bit n is one, event n sets the HALT_H bit in the CTRL register (event 0 = bit 16, event 1 = bit 17, etc.). The number of bits = number of events in this SCT."]
    #[inline(always)]
