...
pub type STARTMSK_L_R = crate::FieldReader<u8, u8>;
...
pub type STARTMSK_L_W<'a, const O: u8> = crate::FieldWriter<'a, u32, START_SPEC, u8, u8, 6, O>;
...
pub type STARTMSK_H_R = crate::FieldReader<u8, u8>;
...
pub type STARTMSK_H_W<'a, const O: u8> = crate::FieldWriter<'a, u32, START_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5 - If bit n is one, event n clears the STOP_L bit in the CTRL register (event 0 = bit 0, event 1 = bit 1, etc.). The number of bits = number of events in this SCT."]
    #[inline(always)]
    pub fn startmsk_l(&self) -> STARTMSK_L_R {
        STARTMSK_L_R::new((self.bits & 0x3f) as u8)
    }
    #[doc = "Bits 16:21 - If bit n is one, event n clears the STOP_H bit in the CTRL register (event 0 = bit 16, event 1 = bit 17, etc.). The number of bits = number of events in this SCT."]
    #[inline(always)]
