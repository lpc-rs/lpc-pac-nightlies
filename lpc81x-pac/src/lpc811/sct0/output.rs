...
pub type OUT_R = crate::FieldReader<u8, u8>;
...
pub type OUT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, OUTPUT_SPEC, u8, u8, 4, O>;
impl R {
    #[doc = "Bits 0:3 - Writing a 1 to bit n forces the corresponding output HIGH. Writing a 0 forces the corresponding output LOW (output 0 = bit 0, output 1 = bit 1, etc.). The number of bits = number of outputs in this SCT."]
    #[inline(always)]
