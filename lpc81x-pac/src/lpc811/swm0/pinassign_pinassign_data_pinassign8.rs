...
pub type I2C_SCL_IO_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN8_SPEC, u8, u8, 8, 0>;
...
pub type ACMP_O_O_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN8_SPEC, u8, u8, 8, 8>;
...
pub type CLKOUT_O_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN8_SPEC, u8, u8, 8, 16>;
...
pub type GPIO_INT_BMAT_O_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN8_SPEC, u8, u8, 8, 24>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - I2C_SCL function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_17 (= 0x11)."]
    #[inline(always)]
    pub fn i2c_scl_io(&mut self) -> I2C_SCL_IO_W {
