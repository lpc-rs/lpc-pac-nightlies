...
pub type CTIN_1_I_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN6_SPEC, u8, u8, 8, 0>;
...
pub type CTIN_2_I_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN6_SPEC, u8, u8, 8, 8>;
...
pub type CTIN_3_I_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN6_SPEC, u8, u8, 8, 16>;
...
pub type CTOUT_0_O_W<'a> =
    crate::FieldWriter<'a, u32, PINASSIGN_PINASSIGN_DATA_PINASSIGN6_SPEC, u8, u8, 8, 24>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - CTIN_1 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_17 (= 0x11)."]
    #[inline(always)]
    pub fn ctin_1_i(&mut self) -> CTIN_1_I_W {
        CTIN_1_I_W::new(self)
    }
    #[doc = "Bits 8:15 - CTIN_2 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_17 (= 0x11)."]
    #[inline(always)]
    pub fn ctin_2_i(&mut self) -> CTIN_2_I_W {
        CTIN_2_I_W::new(self)
    }
    #[doc = "Bits 16:23 - CTIN_3 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_17 (= 0x11)."]
    #[inline(always)]
    pub fn ctin_3_i(&mut self) -> CTIN_3_I_W {
        CTIN_3_I_W::new(self)
    }
    #[doc = "Bits 24:31 - CTOUT_0 function assignment. The value is the pin number to be assigned to this function. The following pins are available: PIO0_0(= 0) to PIO0_17 (= 0x11)."]
    #[inline(always)]
    pub fn ctout_0_o(&mut self) -> CTOUT_0_O_W {
