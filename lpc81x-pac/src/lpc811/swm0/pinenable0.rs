...
pub type ACMP_I1_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, ACMP_I1_A, 0>;
impl<'a> ACMP_I1_W<'a> {
...
pub type ACMP_I2_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, ACMP_I2_A, 1>;
impl<'a> ACMP_I2_W<'a> {
...
pub type SWCLK_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, SWCLK_A, 2>;
impl<'a> SWCLK_W<'a> {
...
pub type SWDIO_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, SWDIO_A, 3>;
impl<'a> SWDIO_W<'a> {
...
pub type XTALIN_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, XTALIN_A, 4>;
impl<'a> XTALIN_W<'a> {
...
pub type XTALOUT_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, XTALOUT_A, 5>;
impl<'a> XTALOUT_W<'a> {
...
pub type RESETN_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, RESETN_A, 6>;
impl<'a> RESETN_W<'a> {
...
pub type CLKIN_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, CLKIN_A, 7>;
impl<'a> CLKIN_W<'a> {
...
pub type VDDCMP_W<'a> = crate::BitWriter<'a, u32, PINENABLE0_SPEC, VDDCMP_A, 8>;
impl<'a> VDDCMP_W<'a> {
