...
pub type RXOV_W<'a, const O: u8> = crate::BitWriter<'a, u32, STAT_SPEC, bool, O>;
...
pub type TXUR_W<'a, const O: u8> = crate::BitWriter<'a, u32, STAT_SPEC, bool, O>;
