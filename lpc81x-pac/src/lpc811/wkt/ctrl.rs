...
pub type CLKSEL_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, CLKSEL_A, 0>;
impl<'a> CLKSEL_W<'a> {
...
pub type ALARMFLAG_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, ALARMFLAG_A, 1>;
...
pub type CLEARCTR_W<'a> = crate::BitWriter<'a, u32, CTRL_SPEC, CLEARCTR_A, 2>;
impl<'a> CLEARCTR_W<'a> {
