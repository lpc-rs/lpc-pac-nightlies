...
pub type MODE_W<'a> = crate::FieldWriterSafe<'a, u32, PIO0_16_SPEC, u8, MODE_A, 2, 3>;
impl<'a> MODE_W<'a> {
...
pub type HYS_W<'a> = crate::BitWriter<'a, u32, PIO0_16_SPEC, HYS_A, 5>;
impl<'a> HYS_W<'a> {
    #[doc = "Disable"]
    #[inline(always)]
...
pub type INV_W<'a> = crate::BitWriter<'a, u32, PIO0_16_SPEC, INV_A, 6>;
impl<'a> INV_W<'a> {
...
pub type OD_W<'a> = crate::BitWriter<'a, u32, PIO0_16_SPEC, OD_A, 10>;
impl<'a> OD_W<'a> {
    #[doc = "Disable."]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
...
pub type S_MODE_W<'a> = crate::FieldWriterSafe<'a, u32, PIO0_16_SPEC, u8, S_MODE_A, 2, 11>;
impl<'a> S_MODE_W<'a> {
...
pub type CLK_DIV_W<'a> = crate::FieldWriter<'a, u32, PIO0_16_SPEC, u8, CLK_DIV_A, 3, 13>;
impl<'a> CLK_DIV_W<'a> {
    #[doc = "IOCONCLKDIV0"]
    #[inline(always)]
