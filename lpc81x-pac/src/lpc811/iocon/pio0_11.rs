...
pub type INV_W<'a, const O: u8> = crate::BitWriter<'a, u32, PIO0_11_SPEC, INV_A, O>;
...
pub type I2CMODE_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PIO0_11_SPEC, u8, I2CMODE_A, 2, O>;
...
pub type S_MODE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, PIO0_11_SPEC, u8, S_MODE_A, 2, O>;
...
pub type CLK_DIV_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, PIO0_11_SPEC, u8, CLK_DIV_A, 3, O>;
