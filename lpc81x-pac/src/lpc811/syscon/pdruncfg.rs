...
pub type IRCOUT_PD_W<'a> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, IRCOUT_PD_A, 0>;
...
pub type IRC_PD_W<'a> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, IRC_PD_A, 1>;
impl<'a> IRC_PD_W<'a> {
    #[doc = "powered"]
    #[inline(always)]
    pub fn powered(self) -> &'a mut W {
...
pub type FLASH_PD_W<'a> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, FLASH_PD_A, 2>;
impl<'a> FLASH_PD_W<'a> {
    #[doc = "powered"]
    #[inline(always)]
    pub fn powered(self) -> &'a mut W {
...
pub type BOD_PD_W<'a> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, BOD_PD_A, 3>;
impl<'a> BOD_PD_W<'a> {
    #[doc = "powered"]
    #[inline(always)]
    pub fn powered(self) -> &'a mut W {
...
pub type SYSOSC_PD_W<'a> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, SYSOSC_PD_A, 5>;
...
pub type WDTOSC_PD_W<'a> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, WDTOSC_PD_A, 6>;
...
pub type SYSPLL_PD_W<'a> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, SYSPLL_PD_A, 7>;
...
pub type ACMP_W<'a> = crate::BitWriter<'a, u32, PDRUNCFG_SPEC, ACMP_A, 15>;
impl<'a> ACMP_W<'a> {
    #[doc = "Disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut W {
