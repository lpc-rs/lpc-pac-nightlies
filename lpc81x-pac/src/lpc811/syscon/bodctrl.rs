...
pub type BODRSTLEV_W<'a> = crate::FieldWriter<'a, u32, BODCTRL_SPEC, u8, BODRSTLEV_A, 2, 0>;
...
pub type BODINTVAL_W<'a> = crate::FieldWriter<'a, u32, BODCTRL_SPEC, u8, BODINTVAL_A, 2, 2>;
...
pub type BODRSTENA_W<'a> = crate::BitWriter<'a, u32, BODCTRL_SPEC, BODRSTENA_A, 4>;
