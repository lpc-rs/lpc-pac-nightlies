...
pub type POR_W<'a> = crate::BitWriter<'a, u32, SYSRSTSTAT_SPEC, POR_A, 0>;
impl<'a> POR_W<'a> {
    #[doc = "No POR detected."]
    #[inline(always)]
...
pub type EXTRST_W<'a> = crate::BitWriter<'a, u32, SYSRSTSTAT_SPEC, EXTRST_A, 1>;
impl<'a> EXTRST_W<'a> {
...
pub type WDT_W<'a> = crate::BitWriter<'a, u32, SYSRSTSTAT_SPEC, WDT_A, 2>;
impl<'a> WDT_W<'a> {
...
pub type BOD_W<'a> = crate::BitWriter<'a, u32, SYSRSTSTAT_SPEC, BOD_A, 3>;
impl<'a> BOD_W<'a> {
...
pub type SYSRST_W<'a> = crate::BitWriter<'a, u32, SYSRSTSTAT_SPEC, SYSRST_A, 4>;
impl<'a> SYSRST_W<'a> {
